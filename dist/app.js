(() => {
  ...
  (function() {
    ...
    const classifyFetchError = (rawErr, url) => {
      ...
      err.url = url;
      err.cause = rawErr;
      if (typeof (rawErr == null ? void 0 : rawErr.message) === "string" && /failed to fetch|networkerror|load failed/i.test(rawErr.message)) {
    ...
    const request = async (method, path, body) => {
      ...
      try {
        ...
        clearTimeout(timer);
        if ((rawErr == null ? void 0 : rawErr.name) === "AbortError") {
          const err = new Error(`\uC694\uCCAD \uC2DC\uAC04 \uCD08\uACFC (${Math.round(timeoutMs / 1e3)}s)`);
          err.kind = "timeout";
          err.code = "TIMEOUT";
          err.url = url;
          err.cause = rawErr;
    ...
    window.BGNJ_API = {
      ...
      changePassword: ({ currentPassword, newPassword }) => request("PATCH", "/me/password", { currentPassword, newPassword }),
      // ── 게시글 ──
      posts: {
        ...
        create: ({ categoryId, title, body, prefix }) => request("POST", "/posts", { categoryId, title, body, prefix }),
      ...
      internalAlarm: {
        send: ({ recipients, title, message, excludeSelf } = {}) => request("POST", "/admin/internal-alarm", { recipients, title, message, excludeSelf })
      },
      // ── 좋아요 / 북마크 ──
      likes: {
      ...
      // ── 신고 ──
      reports: {
        create: ({ postId, postTitle, reason, reporterName }) => request("POST", "/reports", { postId, postTitle, reason, reporterName })
      },
      // ── 관리자 ──
      admin: {
        users: {
      ...
      errorLog: {
        ...
        report: ({ code, status, kind, message, hint, url, pathname, origin }) => request("POST", "/error-log", { code, status, kind, message, hint, url, pathname, origin }),
        list: ({ limit, code } = {}) => {
  ...
  window.BGNJ_GUARD = {
    arr(fn, fallback) {
      try {
        const v = fn();
        return Array.isArray(v) ? v : fallback != null ? fallback : [];
      } catch (e) {
  ...
  window.BGNJ_DRAFTS = {
    ...
    purge() {
      const now = Date.now();
      const ageMs = this.MAX_AGE_DAYS * 24 * 60 * 60 * 1e3;
    ...
    save(payload) {
      ...
      const draft = { ...payload, id, savedAt: (/* @__PURE__ */ new Date()).toISOString() };
  ...
  try {
    ...
    if (mq) {
      const onChange = () => {
        if (window.BGNJ_THEME.get() === "auto") window.BGNJ_THEME.apply();
      };
  ...
  window.BGNJ_DIAG = {
    async run() {
      const result = { version: window.BGNJ_VERSION, origin: location.origin, time: (/* @__PURE__ */ new Date()).toISOString() };
      try {
        const t0 = performance.now();
        const health = await window.BGNJ_API.health();
        result.health = { ok: true, latencyMs: Math.round(performance.now() - t0), ...health };
      } catch (err) {
        result.health = { ok: false, code: err == null ? void 0 : err.code, status: err == null ? void 0 : err.status, message: err == null ? void 0 : err.message, url: err == null ? void 0 : err.url };
      }
      try {
        const me = await window.BGNJ_API.me();
        result.session = { ok: true, user: (me == null ? void 0 : me.user) || null };
      } catch (err) {
        result.session = { ok: false, code: err == null ? void 0 : err.code, status: err == null ? void 0 : err.status, message: err == null ? void 0 : err.message };
      }
  ...
  (function cleanupV33() {
    try {
      ...
      const KEEP_EXACT = /* @__PURE__ */ new Set([
        "bgnj_session_user",
        // FCP 캐시
        "bgnj_route",
        // 마지막 라우트
      ...
      const PURGE = [
        ...
        "bgnj_book_reviews",
        "bgnj_books",
        "bgnj_lecture_overrides",
        "bgnj_lecture_registrations",
        "bgnj_lecture_reviews",
        "bgnj_tour_overrides",
        "bgnj_tour_reservations",
        "bgnj_tour_reviews",
        "bgnj_user_columns",
        "bgnj_column_engagement",
        "bgnj_audit_log",
        "bgnj_legal_docs",
        "bgnj_faqs",
        "bgnj_bank_account",
    ...
    window.BGNJ_SAFE_HTML = function(html) {
      ...
      return window.DOMPurify.sanitize(String(html || ""), {
        ...
        ALLOWED_TAGS: [
          ...
          "th",
          "iframe",
          // YouTube/Vimeo 임베드 — hook 으로 도메인 검증.
          "hr"
        ],
        ALLOWED_ATTR: [
          "href",
          ...
          "class",
          "style",
          // class/style 은 Tiptap 인라인 스타일 (text-align 등) 위해 필요
          "data-type",
          "data-checked",
          "data-youtube-video",
          "allow",
  ...
  window.BGNJ_FMT = {
    ...
    kstRelative(iso) {
      ...
      if (diff < 30 * 864e5) return `${Math.floor(diff / 864e5)}\uC77C \uC804`;
  ...
  var _asRecord = (value, fallback = {}) => value && typeof value === "object" && !Array.isArray(value) ? value : fallback;
  var BGNJ_STORAGE_VERSION = "v6-comments-dead";
  try {
    ...
    if (prevVer !== BGNJ_STORAGE_VERSION) {
      ...
      localStorage.removeItem("bgnj_users");
  ...
  var migrateLegacyGradeColors = (grades) => {
  ...
  var DEFAULT_SITE_CONTENT = {
    ...
    hero: {
      eyebrow: "BANGINOJA \xB7 \uBA39\uACE0 \uC790\uACE0 \uB180\uC790 \uC640 \uC778\uBB38\uD559 \uC5EC\uD589",
      title1: "\uBC45\uAE30\uD0C0\uACE0",
      title2: "\uD55C\uAD6D\uC744",
      title3: "\uB290\uB07C\uB2E4",
      subtitle: "\uC758\uC2DD\uC8FC(\u8863\u98DF\u4F4F) \uC0DD\uD65C\uC758 3\uC694\uC18C\uC5D0 \uD589\uBB38(\u884C\u6587)\uC774 \uACB0\uD569\uB418\uB294 \uC5EC\uC815.\n\uBA39\uACE0\xB7\uC790\uACE0\xB7\uB180\uACE0\xB7\uBC30\uC6B0\uB294 \uD55C\uAD6D\uC744, \uBC45\uAE30\uB178\uC790\uC640 \uD568\uAED8 \uAC77\uACE0 \uB290\uB08D\uB2C8\uB2E4.",
      ctaPrimary: "\uAD11\uC7A5 \uCC38\uC5EC\uD558\uAE30 \u2192",
    ...
    footer: {
      description: "\uBC45\uAE30\uD0C0\uACE0 \uB178\uC790. \uBC45\uAE30\uB178\uC790\uB294 \uD55C\uAD6D\uC758 \uC5ED\uC0AC\xB7\uBB38\uD654\xB7\uC790\uC5F0\uC744 \uD568\uAED8 \uAC77\uACE0 \uB290\uB07C\uBA70 \uB098\uB204\uB294 \uC5EC\uD589 \uAD11\uC7A5\uC785\uB2C8\uB2E4. \uAD81\uAD90 \uB2F5\uC0AC\uBD80\uD130 \uC9C0\uC5ED \uC5EC\uD589\uAE4C\uC9C0, \uD568\uAED8 \uB9CC\uB4E4\uC5B4\uAC00\uB294 \uC5EC\uD589.",
      signature: "\uBC45\uAE30\uD0C0\uACE0 \uB178\uC790 \xB7 DESIGNED IN SEOUL",
      // v00.073 — 푸터 잔존 하드코드 추출. 비면 코드 default.
      copyright: "\xA9 2026 \uBC45\uAE30\uB178\uC790 BANGINOJA \u2014 ALL RIGHTS RESERVED",
      headingContent: "\uCF58\uD150\uCE20",
      headingInfo: "\uC815\uBCF4",
      headingContact: "\uC5F0\uB77D"
    },
    ...
    og: {
      ...
      description: "\uBC45\uAE30\uB178\uC790 \u2014 \uBC45\uAE30 \uD0C0\uACE0 \uD55C\uAD6D\uC744 \uB290\uB07C\uB2E4. \uAD81\uAD90 \uB2F5\uC0AC\uBD80\uD130 \uC9C0\uC5ED \uC5EC\uD589\uAE4C\uC9C0, \uD55C\uAD6D\uC758 \uC5ED\uC0AC\xB7\uBB38\uD654\xB7\uC790\uC5F0\uC744 \uD568\uAED8 \uC5EC\uD589\uD558\uB294 \uCEE4\uBBA4\uB2C8\uD2F0.",
      imageDataUri: ""
    },
    ...
    contact: {
      ...
      ceo: "\uBC31\uC2B9\uAE30",
      bizRegNo: "551-86-02188",
      // 사업자등록번호
      corpRegNo: "110111-7817690",
      // 법인등록번호
      founded: "2021-04-01"
      // 개업일
    },
    ...
    tourIntro: {
      ...
      titlePrefix: "\uBC1C\uB85C \uC77D\uB294 ",
      titleAccent: "\uC870\uC120",
      subtitle: "\uBC45\uAE30\uB178\uC790\uC640 \uC655\uC0AC\uB0A8\uC774 \uC9C1\uC811 \uC6B4\uC601\uD558\uB294 \uD504\uB85C\uADF8\uB7A8. \uD68C\uC6D0 \uC804\uC6A9 \uC2E0\uCCAD \xB7 \uBB34\uD1B5\uC7A5 \uC785\uAE08 \uACB0\uC81C."
    },
    ...
    lectureIntro: {
      eyebrow: "LECTURE \xB7 \uC655\uC0AC\uB0A8 \uAC15\uC5F0",
      titlePrefix: "\uC655\uC0AC\uB0A8 ",
      titleAccent: "\uAC15\uC5F0 \uC77C\uC815",
      subtitle: "\uACF5\uAC1C / \uC2EC\uD654 / \uD604\uC7A5 \uAC15\uC5F0. \uD68C\uC6D0 \uC804\uC6A9 \uC2E0\uCCAD \xB7 \uBB34\uD1B5\uC7A5 \uC785\uAE08 \uACB0\uC81C."
    },
    ...
    faqIntro: {
      eyebrow: "FAQ \xB7 \uC790\uC8FC \uBB3B\uB294 \uC9C8\uBB38",
      titlePrefix: "",
      titleAccent: "\uC790\uC8FC \uBB3B\uB294",
      titleSuffix: " \uC9C8\uBB38",
      subtitle: "\uAC00\uC785\xB7\uACB0\uC81C\xB7\uAC15\uC5F0\xB7\uB2F5\uC0AC\xB7\uCC45 \uC8FC\uBB38\uC5D0 \uAD00\uD574 \uC790\uC8FC \uB4E4\uC5B4\uC624\uB294 \uC9C8\uBB38\uC744 \uC815\uB9AC\uD588\uC2B5\uB2C8\uB2E4."
    },
    myPageIntro: {
      eyebrow: "MY PAGE \xB7 \uD68C\uC6D0 \uC815\uBCF4",
    ...
    eatIntro: {
      eyebrow: "EAT \xB7 \uBA39\uACE0 \uB180\uC790",
      title: "\uBA39\uACE0 \uB180\uC790",
      sub: "\uD55C\uAD6D\uC758 \uB9DB, \uD55C \uB07C\uC758 \uC778\uBB38\uD559",
      desc: "\uC2DD(\u98DF) \u2014 \uC9C0\uC5ED\uC758 \uC2DD\uC7AC\uB8CC\uC640 \uC190\uB9DB\uC744 \uB530\uB77C\uAC00\uB294 \uC5EC\uC815. \uBC45\uAE30\uB178\uC790\uC640 \uD568\uAED8 \uAC80\uC99D\uB41C \uC2DD\uB2F9\uACFC \uC885\uAC00 \uC74C\uC2DD\uC744 \uB9CC\uB0A9\uB2C8\uB2E4.",
      accent: "#E8A540",
      categories: ["\uC804\uD1B5 \uD55C\uC815\uC2DD", "\uD5A5\uD1A0 \uC74C\uC2DD", "\uC2DC\uC7A5 \uBA39\uAC70\uB9AC", "\uC81C\uCCA0 \uC2DD\uC7AC", "\uC8FC\uC548\uC0C1\xB7\uBC1C\uD6A8"]
    },
    sleepIntro: {
      eyebrow: "STAY \xB7 \uC790\uACE0 \uB180\uC790",
      title: "\uC790\uACE0 \uB180\uC790",
      sub: "\uBA38\uBB34\uB294 \uACF3\uC5D0\uC11C \uC2DC\uC791\uB418\uB294 \uC5EC\uD589",
      desc: "\uC8FC(\u4F4F) \u2014 \uD55C\uC625\xB7\uC804\uD1B5 \uAC8C\uC2A4\uD2B8\uD558\uC6B0\uC2A4\xB7\uACE0\uD0DD \uC2A4\uD14C\uC774\uAE4C\uC9C0. \uBA38\uBB34\uB294 \uC2DC\uAC04\uC774 \uACE7 \uD48D\uACBD\uC774 \uB418\uB294 \uC219\uBC15\uC744 \uD050\uB808\uC774\uC158\uD569\uB2C8\uB2E4.",
      accent: "#5A8FBF",
      categories: ["\uD55C\uC625 \uC2A4\uD14C\uC774", "\uACE0\uD0DD / \uC885\uAC00", "\uAC8C\uC2A4\uD2B8\uD558\uC6B0\uC2A4", "\uD15C\uD50C \uC2A4\uD14C\uC774", "\uB18D\uAC00 \uCCB4\uD5D8"]
    },
    shopIntro: {
      eyebrow: "SHOP \xB7 \uC0AC\uACE0 \uB180\uC790",
      title: "\uC0AC\uACE0 \uB180\uC790",
      sub: "\uC9D1\uC73C\uB85C \uAC00\uC838\uC624\uB294 \uD55C\uAD6D\uC758 \uC190\uAE38",
      desc: "\uC758(\u8863) + \uD1A0\uC0B0 \u2014 \uC9C0\uC5ED \uC7A5\uC778\uC758 \uACF5\uC608\uC640 \uD1A0\uC0B0\uBB3C\uC744 \uD55C\uC790\uB9AC\uC5D0. \uC190\uC5D0 \uB2FF\uB294 \uD55C\uAD6D\uC744 \uAC00\uC838\uAC11\uB2C8\uB2E4.",
      accent: "#9C6FB3",
      categories: ["\uC804\uD1B5 \uACF5\uC608", "\uC9C0\uC5ED \uD1A0\uC0B0\uBB3C", "\uC758\uB958\xB7\uC804\uD1B5 \uC9C1\uBB3C", "\uB3C4\uC790\xB7\uAE08\uC18D", "\uBCF4\uC874\xB7\uBC1C\uD6A8 \uC2DD\uD488"]
    },
    ...
    try {
      ...
      const mergeStats = () => {
        ...
        for (const k of ["label", "value", "sub"]) {
          const desktop = { ...d.stats[k], ...((_a2 = o.stats) == null ? void 0 : _a2[k]) || {} };
          const mobileK = isMobile ? { ...((_c2 = (_b2 = d.mobile) == null ? void 0 : _b2.stats) == null ? void 0 : _c2[k]) || {}, ...((_d2 = mob.stats) == null ? void 0 : _d2[k]) || {} } : {};
          result[k] = { ...desktop, ...mobileK };
        }
        return result;
      };
      return {
        eyebrow: mergeWithMobile("eyebrow", (_c = d.mobile) == null ? void 0 : _c.eyebrow),
        title: mergeWithMobile("title", (_d = d.mobile) == null ? void 0 : _d.title),
        subtitle: mergeWithMobile("subtitle", (_e = d.mobile) == null ? void 0 : _e.subtitle),
        cta: mergeWithMobile("cta", (_f = d.mobile) == null ? void 0 : _f.cta),
        stats: mergeStats()
      };
    } catch (e) {
      return window.BGNJ_HERO_STYLE_DEFAULT;
    }
  };
  ...
  window.BGNJ_FOOTER_STYLE = function() {
    ...
    try {
      ...
      return window.BGNJ_FOOTER_STYLE_DEFAULT;
    }
  };
  ...
  var normalizeCommunityPost = (post) => {
    ...
    return {
      ...
      categoryId,
      category,
      replies: (_b = post.replies) != null ? _b : 0,
      views: (_c = post.views) != null ? _c : 0
    };
  };
  var ensureCommunityPostsSeeded = (posts, legacyUserPosts) => {
  ...
  window.BGNJ_STORES = {
    ...
    legalDocs: _asRecord(_lsGet("bgnj_legal_docs", {
      ...
      privacy: {
        title: "\uAC1C\uC778\uC815\uBCF4 \uCC98\uB9AC\uBC29\uCE68",
        body: "<p>\uBC45\uAE30\uB178\uC790 \uC0AC\uC774\uD2B8\uB294 \uD68C\uC6D0 \uAC00\uC785\uACFC \uC6B4\uC601\uC744 \uC704\uD574 \uCD5C\uC18C\uD55C\uC758 \uAC1C\uC778\uC815\uBCF4\uB97C \uC218\uC9D1\xB7\uC774\uC6A9\uD569\uB2C8\uB2E4.</p><h4>\uC218\uC9D1 \uD56D\uBAA9</h4><ul><li>\uD544\uC218: \uC774\uBA54\uC77C, \uC774\uB984, \uBE44\uBC00\uBC88\uD638(\uB2E8\uBC29\uD5A5 \uD574\uC2DC \uC800\uC7A5)</li><li>\uC790\uB3D9 \uC218\uC9D1(\uC811\uC18D \uAE30\uB85D): <strong>\uB9C8\uC9C0\uB9C9 \uC811\uC18D \uC77C\uC2DC</strong> \u2014 \uD734\uBA74 \uACC4\uC815 \uC2DD\uBCC4, \uBCF4\uC548 \uBAA8\uB2C8\uD130\uB9C1, \uC11C\uBE44\uC2A4 \uC6B4\uC601 \uBAA9\uC801</li></ul><p>\uC811\uC18D \uAE30\uB85D\uC740 IP/\uB2E8\uB9D0 \uC815\uBCF4\uB97C \uC800\uC7A5\uD558\uC9C0 \uC54A\uC73C\uBA70, \uB2E8\uC77C timestamp \uB9CC \uB36E\uC5B4\uC4F0\uAE30 \uBC29\uC2DD\uC73C\uB85C \uBCF4\uAD00\uD569\uB2C8\uB2E4. \uACC4\uC815 \uD0C8\uD1F4 \uC2DC \uBAA8\uB4E0 \uAC1C\uC778\uC815\uBCF4\uC640 \uD568\uAED8 \uC989\uC2DC \uD30C\uAE30\uB429\uB2C8\uB2E4.</p><p>\uC774 \uBB38\uC11C\uB294 \uAD00\uB9AC\uC790 \uD398\uC774\uC9C0\uC5D0\uC11C \uC9C1\uC811 \uC218\uC815\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.</p>",
        updatedAt: null
      },
    ...
    faqs: _asArray(_lsGet("bgnj_faqs", [
      ...
      { id: "faq-2", question: "\uAC15\uC5F0\xB7\uB2F5\uC0AC \uACB0\uC81C\uB294 \uC5B4\uB5BB\uAC8C \uC9C4\uD589\uB418\uB098\uC694?", answer: "\uD604\uC7AC\uB294 \uBB34\uD1B5\uC7A5 \uC785\uAE08\uB9CC \uC9C0\uC6D0\uD569\uB2C8\uB2E4. \uC2E0\uCCAD \u2192 \uC548\uB0B4 \uACC4\uC88C\uB85C \uC785\uAE08 \u2192 \uC6B4\uC601\uC790 \uC785\uAE08 \uD655\uC778 \u2192 \uCC38\uAC00 \uD655\uC815 \uC21C\uC73C\uB85C \uC9C4\uD589\uB429\uB2C8\uB2E4.", category: "\uACB0\uC81C", order: 1 },
  ...
  window.BGNJ_SAVE = {
    ...
    resetGrades: () => {
      window.BGNJ_STORES.grades = DEFAULT_GRADES.slice();
      _lsSet("bgnj_grades", window.BGNJ_STORES.grades);
    },
    resetCategories: () => {
  ...
  window.BGNJ_AUTH = {
    hashPassword,
    // legacy — 외부 코드 호환용. 신규 비밀번호 검증에는 사용되지 않음.
    ...
    _classifyAuthError(err, fallback) {
      var _a;
      const kind = (err == null ? void 0 : err.kind) || "unknown";
      const code = (err == null ? void 0 : err.code) || ((err == null ? void 0 : err.status) ? `HTTP_${err.status}` : "UNKNOWN");
      const status = (err == null ? void 0 : err.status) || null;
      const serverMsg = ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || null;
      let message = serverMsg || (err == null ? void 0 : err.message) || fallback;
      let hint = "";
      if (kind === "network") {
        hint = "\uC778\uD130\uB137 \uC5F0\uACB0 \uB610\uB294 \uC11C\uBC84 \uB3C4\uB2EC\uC774 \uCC28\uB2E8\uB410\uC2B5\uB2C8\uB2E4. \uB124\uD2B8\uC6CC\uD06C/\uBC29\uD654\uBCBD/\uAD11\uACE0\uCC28\uB2E8/CORS \uC124\uC815\uC744 \uD655\uC778\uD574 \uC8FC\uC138\uC694. (\uC694\uCCAD \uC8FC\uC18C: " + ((err == null ? void 0 : err.url) || "?") + ")";
      } else if (status === 401) {
      ...
      return { ok: false, code, status, kind, message, hint, url: (err == null ? void 0 : err.url) || null };
    },
    ...
    async setGrade(userId, gradeId) {
      ...
      if (((_a = window.BGNJ_STORES.session) == null ? void 0 : _a.id) === userId) {
    ...
    async toggleAdmin(userId) {
      ...
      if (((_a = window.BGNJ_STORES.session) == null ? void 0 : _a.id) === userId && next) {
    ...
    async fetchActivity(userId) {
      ...
      try {
        ...
        const a = (res == null ? void 0 : res.activity) || res || {};
        const result = {
    ...
    getActivity(userId) {
      ...
      const posts = (((_b = (_a = window.BGNJ_COMMUNITY) == null ? void 0 : _a.listPosts) == null ? void 0 : _b.call(_a)) || []).filter((p) => p.authorId === userId);
      const comments = 0;
      const bookOrders = ((_d = (_c = window.BGNJ_BOOK_ORDERS) == null ? void 0 : _c.listMine) == null ? void 0 : _d.call(_c, userId)) || [];
      const lectures = ((_f = (_e = window.BGNJ_LECTURES) == null ? void 0 : _e.listMyRegistrations) == null ? void 0 : _f.call(_e, userId)) || [];
      const tours = ((_h = (_g = window.BGNJ_TOURS) == null ? void 0 : _g.listMyReservations) == null ? void 0 : _h.call(_g, userId)) || [];
      const bookmarks = ((_j = (_i = window.BGNJ_COMMUNITY) == null ? void 0 : _i.getBookmarks) == null ? void 0 : _j.call(_i, userId)) || [];
      const notifications = ((_l = (_k = window.BGNJ_COMMUNITY) == null ? void 0 : _k.listNotifications) == null ? void 0 : _l.call(_k, userId)) || [];
      return {
  ...
  window.BGNJ_COMMUNITY = {
    ...
    listPosts() {
      if (this._serverLoaded) {
        ...
        const localOnly = (window.BGNJ_STORES.communityPosts || []).filter((p) => !serverIds.has(String(p.id)));
        return [...this._serverPosts, ...localOnly].slice().sort((a, b) => String(b.createdAt || b.date).localeCompare(String(a.createdAt || a.date)));
      }
      return [];
    },
    getPost(postId) {
    ...
    async refreshPosts(opts = {}) {
      ...
      for (let attempt = 0; attempt < maxAttempts; attempt++) {
        try {
          ...
          const { posts } = await window.BGNJ_API.posts.list({ limit: 1e3, ...opts });
    ...
    updatePost(postId, patch) {
      ...
      const posts = this.listPosts().map((post) => String(post.id) === String(postId) ? normalizeCommunityPost({ ...post, ...patch, updatedAt: (/* @__PURE__ */ new Date()).toISOString() }) : post);
    ...
    getLikes(postId) {
      const post = this.getPost(postId);
      return Array.isArray(post == null ? void 0 : post.likes) ? post.likes.slice() : [];
    },
    ...
    async toggleLike(postId, userId) {
      if (!userId) return null;
      const post = this.getPost(postId);
      const cur = Array.isArray(post == null ? void 0 : post.likes) ? post.likes : [];
      ...
      try {
        ...
        const arr = Array.isArray(res == null ? void 0 : res.likes) ? res.likes : optimistic;
  ...
  window.BGNJ_COLUMNS = {
    ...
    getLikes(id) {
      var _a;
      return ((_a = this._columns.find((c) => String(c.id) === String(id))) == null ? void 0 : _a.likes) || [];
    },
    hasLiked(id, userId) {
      return !!userId && this.getLikes(id).includes(userId);
    },
    async toggleLike(id, _userId) {
      ...
      try {
        ...
        (_c = (_b = (_a = window.BGNJ_API) == null ? void 0 : _a.errorLog) == null ? void 0 : _b.report) == null ? void 0 : _c.call(_b, { kind: "http", code: (err == null ? void 0 : err.code) || "COLUMN_LIKE_FAIL", message: (err == null ? void 0 : err.message) || "\uCE7C\uB7FC \uC88B\uC544\uC694 \uC2E4\uD328", url: err == null ? void 0 : err.url });
        return null;
      }
    },
    getViews(id) {
      var _a;
      return ((_a = this._columns.find((c) => String(c.id) === String(id))) == null ? void 0 : _a.views) || 0;
    },
    ...
    getColumn(id) {
      ...
      const seed = (((_a = window.BANGINOJA_DATA) == null ? void 0 : _a.columns) || []).find((c) => String(c.id) === String(id));
    ...
    async saveColumn(payload) {
      ...
      const rawHtml = typeof payload.body === "object" ? ((_a = payload.body) == null ? void 0 : _a.html) || ((_b = payload.body) == null ? void 0 : _b.text) || "" : payload.body || "";
      ...
      const body = {
        ...
        scheduledAt: payload.publishAt || payload.scheduledAt,
  ...
  window.BGNJ_LECTURES = {
    _lectures: [],
    _myRegs: [],
    _registrationsByLecture: {},
    // 관리자가 강연별 신청 목록을 fetch 한 결과 캐시
    _reviewsByLecture: {},
    _toLecture(r) {
      if (!r) return null;
      return {
    ...
    getLecture(id) {
      return this._lectures.find((l) => String(l.id) === String(id)) || null;
    },
    ...
    listRegistrations(lectureId) {
      return (this._registrationsByLecture[String(lectureId)] || []).slice();
    },
    async refreshRegistrations(lectureId) {
      ...
      try {
        ...
        const mapped = registrations.map((r) => ({
          ...
          paidAt: r.paid_at,
          cancelledAt: r.cancelled_at,
          attended: r.attended === null || r.attended === void 0 ? null : Number(r.attended) === 1
        }));
    ...
    getSeats(lectureId) {
      ...
      const cap = (lecture == null ? void 0 : lecture.capacity) || 0;
    ...
    async register(lectureId, payload) {
      ...
      try {
        ...
        return { ok: false, message: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uC2E0\uCCAD \uC2E4\uD328" };
      }
    },
    ...
    listMyRegistrations(_userId) {
      return this._myRegs.slice();
    },
    // ── .ics ──
    generateIcs(lecture) {
      if (!(lecture == null ? void 0 : lecture.startsAt)) return null;
      const start = new Date(lecture.startsAt);
      const dur = (lecture.durationMinutes || 90) * 60 * 1e3;
...
` : "") + (lecture.note || ""))}`,
    ...
    listReviews(lectureId) {
      return (this._reviewsByLecture[String(lectureId)] || []).slice();
    },
    ...
    async addReview(lectureId, payload) {
      ...
      try {
        ...
        return { ok: false, message: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) };
      }
    },
      ...
      try {
        ...
        this._bankAccounts = accounts.map((a) => {
          ...
          return {
            ...
            order: (_a = a.display_order) != null ? _a : 0
          };
        });
    ...
    getBankAccountById(id) {
      return this._bankAccounts.find((a) => a.id === id) || null;
    },
  ...
  window.BGNJ_BOOK_ORDERS = {
    ...
    // user scope (본인)
    _reviews: [],
    // 책별 리뷰는 서버에서 책 ID 기준 fetch (BGNJ_BOOKS.refreshReviews)
    _toOrder(r) {
      return {
        id: r.id,
        orderNo: r.order_no || r.orderNo,
        bookId: r.book_id || r.bookId,
        // v00.074 audit — 어떤 책 주문인지 식별 (FK)
        userId: r.user_id,
        version: r.version,
        qty: r.qty,
    ...
    listAll() {
      return this._ordersAll.slice().sort((a, b) => String(b.createdAt).localeCompare(String(a.createdAt)));
    },
    listByStatus(status) {
    ...
    listMine(userId) {
      ...
      return this._ordersAll.filter((o) => o.userId === userId).sort((a, b) => String(b.createdAt).localeCompare(String(a.createdAt)));
    },
    // v00.262.002 — getOrder 는 양 캐시 모두에서 검색 (admin 이 본인 주문 lookup 등).
    getOrder(id) {
      return this._ordersAll.find((o) => o.id === id) || this._ordersMine.find((o) => o.id === id) || null;
    },
    countOpenOrders() {
      return this._ordersAll.filter((o) => o.status === "pending_payment").length;
    },
    async createOrder(payload) {
      ...
      const bookId = payload.bookId || ((_c = (_b = (_a = window.BGNJ_BOOKS) == null ? void 0 : _a.primary) == null ? void 0 : _b.call(_a)) == null ? void 0 : _c.id);
      ...
      try {
        ...
        return { ok: false, message: ((_d = err == null ? void 0 : err.body) == null ? void 0 : _d.error) || (err == null ? void 0 : err.message) || "\uC8FC\uBB38 \uC0DD\uC131 \uC2E4\uD328" };
      }
    },
    ...
    getOrderBookTitle(order) {
      ...
      const book = id ? (_b = (_a = window.BGNJ_BOOKS) == null ? void 0 : _a.get) == null ? void 0 : _b.call(_a, id) : null;
      return (book == null ? void 0 : book.title) || ((_e = (_d = (_c = window.BGNJ_BOOKS) == null ? void 0 : _c.primary) == null ? void 0 : _d.call(_c)) == null ? void 0 : _e.title) || "\uCC45";
    },
    ...
    async confirmPayment(id) {
      return this._patch(id, { status: "paid" });
    },
    async unconfirmPayment(id) {
      return this._patch(id, { status: "pending_payment" });
    },
    async markShipped(id, tracking) {
      return this._patch(id, { status: "shipped", tracking: tracking || "" });
    },
    async markDelivered(id) {
      return this._patch(id, { status: "delivered" });
    },
    async cancelOrder(id) {
      return this._patch(id, { status: "cancelled" });
    },
    ...
    async rejectRefund(id, adminNote) {
      return this._patch(id, { status: "paid", refundAdminNote: String(adminNote || "").trim() });
    },
    ...
    async adminDeleteOrder(id) {
      ...
      try {
        ...
        return { ok: false, message: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uC8FC\uBB38 \uC0AD\uC81C \uC2E4\uD328" };
      }
    },
    generateReceipt(id) {
      var _a, _b;
      ...
      const bank = ((_b = (_a = window.BGNJ_LECTURES) == null ? void 0 : _a.getBankAccount) == null ? void 0 : _b.call(_a)) || {};
      const formatPrice = (p) => window.BGNJ_FMT.won(p);
      const lines = [
        "\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557",
        "\u2551         \uBC45\uAE30\uB178\uC790 \xB7 BANGINOJA \uC8FC\uBB38 \uC601\uC218\uC99D     \u2551",
        "\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D",
        "",
        `\uC8FC\uBB38\uBC88\uD638      ${order.orderNo}`,
      ...
      lines.push("\uC6B4\uC601 \uBB38\uC758 \xB7 contact@bgnj.net");
      lines.push("\uC601\uC218\uC99D \uBC1C\uD589 \xB7 " + window.BGNJ_FMT.kstDateTime((/* @__PURE__ */ new Date()).toISOString()));
    ...
    listReviews() {
      return this._reviews.slice().sort((a, b) => String(b.created_at || b.createdAt).localeCompare(String(a.created_at || a.createdAt)));
    },
    canReview(userId) {
      return userId && this.listMine(userId).some((o) => o.status === "delivered");
    },
    hasReviewed(userId) {
      return userId && this._reviews.some((r) => r.user_id === userId || r.userId === userId);
    },
    async addReview({ userId, rating, text }) {
      ...
      try {
        ...
        return { ok: false, message: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uB9AC\uBDF0 \uB4F1\uB85D \uC2E4\uD328" };
      }
    },
  ...
  window.BGNJ_TOURS = {
    ...
    getTour(id) {
      return this._tours.find((t) => String(t.id) === String(id)) || null;
    },
    ...
    listReservations(tourId) {
      return (this._reservationsByTour[String(tourId)] || []).slice();
    },
    ...
    getSeats(tourId) {
      ...
      return { capacity: (tour == null ? void 0 : tour.capacity) || 0, taken: 0, waitlist: 0, remaining: (tour == null ? void 0 : tour.capacity) || 0 };
    },
    ...
    async reserve(tourId, payload) {
      ...
      try {
        ...
        return { ok: false, message: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uC608\uC57D \uC2E4\uD328" };
      }
    },
    ...
    listMyReservations(_userId) {
      return this._myReservations.slice();
    },
    // ── .ics ──
    generateIcs(tour) {
      if (!(tour == null ? void 0 : tour.startsAt)) return null;
      const start = new Date(tour.startsAt);
      const dur = (tour.durationMinutes || 180) * 60 * 1e3;
      const end = new Date(start.getTime() + dur);
      const fmt = (d) => {
        const pad = (n) => String(n).padStart(2, "0");
        return `${d.getUTCFullYear()}${pad(d.getUTCMonth() + 1)}${pad(d.getUTCDate())}T${pad(d.getUTCHours())}${pad(d.getUTCMinutes())}${pad(d.getUTCSeconds())}Z`;
      ...
      return [
        ...
        `LOCATION:${escape(tour.location || tour.title || "")}`,
    ...
    listReviews(tourId) {
      return (this._reviewsByTour[String(tourId)] || []).slice();
    },
  ...
  window.BGNJ_HANGYEON = {
    ...
    getRoomType(id) {
      return this._roomTypes.find((r) => String(r.id) === String(id)) || null;
    },
    async availability({ from, to, roomTypeId } = {}) {
      var _a;
      try {
        return await window.BGNJ_API.hangyeon.availability({ from, to, roomTypeId });
      } catch (err) {
        return { from, to, availability: {}, error: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uC870\uD68C \uC2E4\uD328" };
      }
    },
    async slots({ roomTypeId, date } = {}) {
      try {
        return await window.BGNJ_API.hangyeon.slots({ roomTypeId, date });
      } catch (e) {
        return { hours: [], dailyRemaining: 0 };
      }
    },
    async day({ from, to } = {}) {
      try {
        const { rooms } = await window.BGNJ_API.hangyeon.day({ from, to });
    ...
    async quote(payload) {
      var _a;
      try {
        return await window.BGNJ_API.hangyeon.quote(payload);
      } catch (err) {
        return { ok: false, reason: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uACAC\uC801 \uC2E4\uD328" };
      }
    },
    async book(payload) {
      var _a;
      try {
        const res = await window.BGNJ_API.hangyeon.book(payload);
        await this.refreshMine();
        return { ok: true, ...res };
      } catch (err) {
        return { ok: false, message: ((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uC608\uC57D \uC2E4\uD328" };
    ...
    async cancelBooking(id) {
      await window.BGNJ_API.hangyeon.cancelBooking(id);
      await this.refreshMine();
    },
    // ── 관리자 ──
    ...
    async deleteRoomType(id) {
      await window.BGNJ_API.hangyeon.removeRoomType(id);
      await this.refreshRoomTypes({ includeAll: true });
    },
    async setAvailability(payload) {
      return window.BGNJ_API.hangyeon.setAvailability(payload);
    },
    async adminBookings(opts = {}) {
      try {
        const { bookings } = await window.BGNJ_API.hangyeon.adminBookings(opts);
    ...
    async patchBooking(id, patch) {
      return window.BGNJ_API.hangyeon.patchBooking(id, patch);
    },
    async bookingLog(id) {
      try {
        const { log } = await window.BGNJ_API.hangyeon.bookingLog(id);
        return log || [];
      } catch (e) {
        return [];
      }
    ...
    async payments(id) {
      try {
        const { payments } = await window.BGNJ_API.hangyeon.payments(id);
        return payments || [];
      } catch (e) {
        return [];
      }
    ...
    async addPayment(id, payload) {
      return window.BGNJ_API.hangyeon.addPayment(id, payload);
    },
    async rateRules() {
      try {
        const { rules } = await window.BGNJ_API.hangyeon.rateRules();
        return rules || [];
      } catch (e) {
        return [];
      }
    },
    async createRateRule(p) {
      return window.BGNJ_API.hangyeon.createRateRule(p);
    },
    async updateRateRule(id, p) {
      return window.BGNJ_API.hangyeon.updateRateRule(id, p);
    },
    async deleteRateRule(id) {
      return window.BGNJ_API.hangyeon.removeRateRule(id);
    },
    async coupons() {
      try {
        const { coupons } = await window.BGNJ_API.hangyeon.coupons();
        return coupons || [];
      } catch (e) {
        return [];
      }
    },
    async upsertCoupon(p) {
      return window.BGNJ_API.hangyeon.upsertCoupon(p);
    },
    async deleteCoupon(code) {
      return window.BGNJ_API.hangyeon.removeCoupon(code);
    },
    async guests() {
      try {
        const { guests } = await window.BGNJ_API.hangyeon.guests();
        return guests || [];
      } catch (e) {
        return [];
      }
    },
    async patchGuest(id, p) {
      return window.BGNJ_API.hangyeon.patchGuest(id, p);
    },
    async units() {
      try {
        const { units } = await window.BGNJ_API.hangyeon.units();
        return units || [];
      } catch (e) {
        return [];
      }
    ...
    async createUnit(p) {
      return window.BGNJ_API.hangyeon.createUnit(p);
    },
    async updateUnit(id, p) {
      return window.BGNJ_API.hangyeon.updateUnit(id, p);
    },
    async deleteUnit(id) {
      return window.BGNJ_API.hangyeon.removeUnit(id);
    }
  };
  window.BGNJ_AUDIT = {
    _cache: [],
    log({ action, target, details } = {}) {
      ...
      const entry = {
        ...
        by: ((_c = (_b = (_a = window.BGNJ_AUTH) == null ? void 0 : _a._readCache) == null ? void 0 : _b.call(_a)) == null ? void 0 : _c.name) || "system",
      ...
      try {
        ...
        this._cache = log.map((e) => {
          ...
          return {
            ...
            action: e.action,
            target: e.target,
            details: (_a = e.details) != null ? _a : e.details_json ? JSON.parse(e.details_json) : null,
            by: e.actor || "system",
    ...
    list({ search = "", limit = 200 } = {}) {
      ...
      return all.filter(
        (e) => String(e.action || "").toLowerCase().includes(q) || String(e.target || "").toLowerCase().includes(q) || String(e.by || "").toLowerCase().includes(q)
      ).slice(0, limit);
    },
    clear() {
      this._cache = [];
  ...
  var REPORT_DEMOTE_THRESHOLD = 5;
  var PROMOTION_PROTECTED = /* @__PURE__ */ new Set(["admin"]);
  window.BGNJ_GRADE_RULES_EFFECTIVE = () => {
    var _a, _b, _c;
    const defaults = window.BGNJ_GRADE_RULES || {};
    const sc = (((_b = (_a = window.BGNJ_SITE_CONTENT) == null ? void 0 : _a.get) == null ? void 0 : _b.call(_a)) || {}).gradeRules || {};
    const allGrades = (((_c = window.BGNJ_STORES) == null ? void 0 : _c.grades) || []).filter((g) => !PROMOTION_PROTECTED.has(g.id) && g.id !== "guest");
    const merged = {};
  ...
  window.BGNJ_GRADE_PROMO = {
    ...
    async fetchServerMetrics(userId) {
      var _a, _b, _c, _d;
      try {
        const r = await ((_d = (_c = (_b = (_a = window.BGNJ_API) == null ? void 0 : _a.admin) == null ? void 0 : _b.users) == null ? void 0 : _c.metrics) == null ? void 0 : _d.call(_c, userId));
    ...
    async prefetchAllServerMetrics({ concurrency = 8 } = {}) {
      var _a;
      const users = (((_a = window.BGNJ_AUTH) == null ? void 0 : _a._usersCache) || []).filter((u) => u == null ? void 0 : u.id);
    ...
    metrics(userId) {
      ...
      const daysSinceSignup = Math.max(0, Math.floor((Date.now() - signupTime) / (24 * 60 * 60 * 1e3)));
      ...
      return {
        posts: (_d = sv == null ? void 0 : sv.posts) != null ? _d : a.postCount || 0,
        comments: (_e = sv == null ? void 0 : sv.comments) != null ? _e : a.commentCount || 0,
        visitsLast30Days: ((_g = (_f = window.BGNJ_VISITS) == null ? void 0 : _f.countLast30Days) == null ? void 0 : _g.call(_f, userId)) || 0,
        daysSinceSignup: (_h = sv == null ? void 0 : sv.daysSinceSignup) != null ? _h : daysSinceSignup,
        likesReceived: (_i = sv == null ? void 0 : sv.likesReceived) != null ? _i : likesReceived,
        activeDays: activeDaysSet.size,
        reportCount: (_j = sv == null ? void 0 : sv.reportCount) != null ? _j : reportCount,
        // v00.137 — 투어 + 강연 참석 합산 (사용자 의도 OR 통합).
        eventsAttended: ((_k = sv == null ? void 0 : sv.toursAttended) != null ? _k : 0) + ((_l = sv == null ? void 0 : sv.lecturesAttended) != null ? _l : 0),
    ...
    evaluate(userId) {
      ...
      const grades = (((_a = window.BGNJ_STORES) == null ? void 0 : _a.grades) || []).slice().sort((a, b) => {
        var _a2, _b2;
        return ((_a2 = a.level) != null ? _a2 : 0) - ((_b2 = b.level) != null ? _b2 : 0);
      });
      for (const g of grades) {
        const rule = rules[g.id];
        if (!rule) continue;
        const ok = m.posts >= (rule.posts || 0) && m.comments >= (rule.comments || 0) && m.visitsLast30Days >= (rule.visitsLast30Days || 0) && m.daysSinceSignup >= (rule.daysSinceSignup || 0) && m.likesReceived >= (rule.likesReceived || 0) && m.activeDays >= (rule.activeDays || 0) && m.eventsAttended >= (rule.eventsAttended || 0) && m.reportCount < ((_b = rule.maxReports) != null ? _b : Infinity);
    ...
    maybePromote(userId) {
      ...
      const currentLv = (_c = (_b = grades.find((g) => g.id === user.gradeId)) == null ? void 0 : _b.level) != null ? _c : 0;
  ...
  window.BGNJ_SITE_CONTENT = {
    ...
    applyHead() {
      ...
      const sc = this.get();
      try {
        const fav = (_a = sc.branding) == null ? void 0 : _a.faviconDataUri;
        if (fav) {
        ...
        if ((_b = sc.og) == null ? void 0 : _b.title) document.title = sc.og.title;
        ...
        setMeta('meta[name="description"]', "content", (_c = sc.og) == null ? void 0 : _c.description);
        setMeta('meta[property="og:title"]', "content", (_d = sc.og) == null ? void 0 : _d.title);
        setMeta('meta[property="og:description"]', "content", (_e = sc.og) == null ? void 0 : _e.description);
        if ((_f = sc.og) == null ? void 0 : _f.imageDataUri) setMeta('meta[property="og:image"]', "content", sc.og.imageDataUri);
  ...
  window.BGNJ_BOOKS = {
    ...
    _toBook(r) {
      ...
      return {
        ...
        pages: r.pages,
        isbn: r.isbn,
        priceKR: r.price_kr || r.priceKR || 0,
        priceEN: r.price_en || r.priceEN || 0,
        desc: r.description || r.desc,
        intro: r.intro,
        ...
        order: (_c = (_b = (_a = r.sort_order) != null ? _a : r.display_order) != null ? _b : r.order) != null ? _c : 0,
        createdAt: r.created_at || r.createdAt,
        updatedAt: r.updated_at || r.updatedAt,
        reviews: []
      };
    ...
    _toBookPayload(payload = {}) {
      const out = { ...payload };
      if ("coverDataUri" in out) {
        out.coverKey = out.coverDataUri;
        delete out.coverDataUri;
      }
      if ("pdfPreviewDataUri" in out) {
        out.pdfKey = out.pdfPreviewDataUri;
        delete out.pdfPreviewDataUri;
      }
      if ("primary" in out) {
        out.isPrimary = !!out.primary;
        delete out.primary;
      }
      if ("order" in out) {
        out.sortOrder = Number(out.order) || 0;
        delete out.order;
      }
      return out;
    },
    ...
    list({ status } = {}) {
      const all = this._books.slice().sort((a, b) => {
        var _a, _b;
    ...
    primary() {
      ...
      return books.find((b) => b.primary && (b.status || "published") === "published") || books.find((b) => (b.status || "published") === "published") || null;
    },
    ...
    async create(payload = {}) {
      ...
      if (res == null ? void 0 : res.id) {
        ...
        try {
          ...
          return (direct == null ? void 0 : direct.book) ? this._toBook(direct.book) : { id: res.id, ...payload };
        } catch (e) {
  ...
  window.BGNJ_FAQ = {
    ...
    async refresh({ admin } = {}) {
      try {
        const { faqs } = admin ? await window.BGNJ_API.faqs.adminList() : await window.BGNJ_API.faqs.list();
        ...
        this._cache = faqs.map((f) => {
          ...
          return {
            ...
            order: (_a = f.display_order) != null ? _a : 0,
            hidden: !!f.hidden
          };
        });
        try {
    ...
    listAll() {
      return this._cache.slice().sort((a, b) => {
        var _a, _b;
        return ((_a = a.order) != null ? _a : 0) - ((_b = b.order) != null ? _b : 0);
      });
    },
    ...
    search(query, category) {
      ...
      return this.listAll().filter((f) => {
        ...
        if (!q) return true;
        return String(f.question || "").toLowerCase().includes(q) || String(f.answer || "").toLowerCase().includes(q);
      });
    },
    async add(payload) {
      const next = {
  ...
  window.BGNJ_AUTHOR_GRADE = ({ authorId, author, authorEmail } = {}) => {
    var _a, _b;
    const users = ((_b = (_a = window.BGNJ_AUTH) == null ? void 0 : _a.listUsers) == null ? void 0 : _b.call(_a)) || [];
    const found = users.find(
      (u) => authorId && u.id === authorId || authorEmail && u.email === authorEmail || author && u.name === author
    );
  ...
  window.BANGINOJA_DATA = {
    ...
    tours: [
      { id: 1, title: "\uACBD\uBCF5\uAD81 \u2014 \uAD8C\uB825\uC758 \uC88C\uD45C\uB97C \uC77D\uB2E4", duration: "3\uC2DC\uAC04", group: "12\uC778 \uC774\uD558", price: "85,000\uC6D0", priceNumber: 85e3, capacity: 12, startsAt: "2026-05-04T10:00:00+09:00", durationMinutes: 180, next: "2026.05.04 \xB7 \uD1A0", level: "\uC785\uBB38", desc: "\uADFC\uC815\uC804\uBD80\uD130 \uACBD\uD68C\uB8E8\uAE4C\uC9C0, \uC870\uC120 \uAC74\uAD6D\uC758 \uC124\uACC4\uB3C4\uB97C \uACF5\uAC04\uC73C\uB85C \uB530\uB77C\uAC11\uB2C8\uB2E4." },
      { id: 2, title: "\uCC3D\uB355\uAD81 \uD6C4\uC6D0 \u2014 \uC655\uC758 \uC0AC\uC720", duration: "4\uC2DC\uAC04", group: "8\uC778 \uC774\uD558", price: "130,000\uC6D0", priceNumber: 13e4, capacity: 8, startsAt: "2026-05-11T18:00:00+09:00", durationMinutes: 240, next: "2026.05.11 \xB7 \uD1A0", level: "\uC2EC\uD654", desc: "\uACF5\uC801 \uACF5\uAC04 \uB108\uBA38, \uC655\uC774 \uC2A4\uC2A4\uB85C\uB97C \uB9C8\uC8FC\uD558\uB358 \uC790\uB9AC. \uC57C\uAC04 \uB2F5\uC0AC \uD55C\uC815." },
      { id: 3, title: "\uC885\uBB18 \u2014 \uCE68\uBB35\uC758 \uAC74\uCD95", duration: "2.5\uC2DC\uAC04", group: "15\uC778 \uC774\uD558", price: "70,000\uC6D0", priceNumber: 7e4, capacity: 15, startsAt: "2026-05-18T10:00:00+09:00", durationMinutes: 150, next: "2026.05.18 \xB7 \uC77C", level: "\uC785\uBB38", desc: "\uC138\uACC4\uC5D0\uC11C \uAC00\uC7A5 \uAE34 \uBAA9\uC870 \uAC74\uCD95\uC774 \uC65C \uBE44\uC5B4 \uC788\uC5B4\uC57C \uD588\uB294\uAC00." },
      { id: 4, title: "\uC218\uC6D0 \uD654\uC131 \u2014 \uC815\uC870\uC758 \uAE30\uD68D", duration: "5\uC2DC\uAC04", group: "10\uC778 \uC774\uD558", price: "150,000\uC6D0", priceNumber: 15e4, capacity: 10, startsAt: "2026-05-25T09:00:00+09:00", durationMinutes: 300, next: "2026.05.25 \xB7 \uD1A0", level: "\uC2EC\uD654", desc: "\uAC1C\uD601 \uAD70\uC8FC\uAC00 \uB0A8\uAE34 \uB3C4\uC2DC. \uADFC\uB300 \uC774\uC804\uC758 \uAC00\uC7A5 \uAE09\uC9C4\uC801 \uC2E4\uD5D8." }
    ],
    lectures: [
      { id: 1, title: "\uC655\uC0AC\uB0A8 \uC6D4\uAC04 \uACF5\uAC1C \uAC15\uC5F0", topic: "\uC655\uC758 \uC790\uB9AC\uB294 \uC5B4\uB5BB\uAC8C \uC124\uACC4\uB418\uC5C8\uB294\uAC00", venue: "\uC11C\uC6B8 \uC885\uB85C \uAC15\uC5F0\uC2E4", next: "2026.05.02 \xB7 \uD1A0 19:00", startsAt: "2026-05-02T19:00:00+09:00", durationMinutes: 90, capacity: 30, price: 0, host: "\uBC45\uAE30\uB178\uC790", seats: "\uC794\uC5EC 18\uC11D", note: "\uC655\uAD8C, \uACF5\uAC04, \uC0C1\uC9D5 \uCCB4\uACC4\uB97C \uC785\uBB38\uC790 \uAD00\uC810\uC5D0\uC11C \uD480\uC5B4\uB0C5\uB2C8\uB2E4." },
      { id: 2, title: "\uC655\uC0AC\uB0A8 \uC2EC\uD654 \uAC15\uC5F0", topic: "\uC138\uC885\uC758 \uCE68\uBB35\uACFC \uC815\uC870\uC758 \uC9C8\uBB38", venue: "\uC628\uB77C\uC778 \uB77C\uC774\uBE0C", next: "2026.05.09 \xB7 \uD1A0 20:00", startsAt: "2026-05-09T20:00:00+09:00", durationMinutes: 120, capacity: 60, price: 2e4, host: "\uBC45\uAE30\uB178\uC790", seats: "\uC794\uC5EC 42\uC11D", note: "\uC2E4\uB85D \uBB38\uC7A5\uC744 \uC911\uC2EC\uC73C\uB85C \uB450 \uAD70\uC8FC\uC758 \uC0AC\uACE0\uBC95\uC744 \uBE44\uAD50\uD569\uB2C8\uB2E4." },
      { id: 3, title: "\uC655\uC0AC\uB0A8 \uD604\uC7A5 \uAC15\uC5F0", topic: "\uCC3D\uB355\uAD81 \uD6C4\uC6D0\uACFC \uC655\uC758 \uC0AC\uC720", venue: "\uCC3D\uB355\uAD81 \uAD8C\uC5ED", next: "2026.05.16 \xB7 \uD1A0 18:30", startsAt: "2026-05-16T18:30:00+09:00", durationMinutes: 150, capacity: 20, price: 5e4, host: "\uC655\uC0AC\uB0A8 \uD300", seats: "\uB300\uAE30 \uC811\uC218", note: "\uB2F5\uC0AC\uC640 \uAC15\uC5F0\uC774 \uACB0\uD569\uB41C \uD604\uC7A5\uD615 \uD504\uB85C\uADF8\uB7A8\uC785\uB2C8\uB2E4." }
    ],
...
(\uBCC0\uACBD \uB0B4\uC6A9\uC740 \uC0AC\uB77C\uC9D1\uB2C8\uB2E4)`,
  ...
  var AuthorGradeBadge = ({ authorId, author, authorEmail, size = "sm" }) => {
    var _a;
  ...
  var NotificationBell = ({ user, onPick }) => {
  ...
  var BanginojaIcon = ({ size = 22 }) => /* @__PURE__ */ React.createElement("svg", { width: size, height: size, viewBox: "0 0 64 64", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("rect", { width: "64", height: "64", rx: "9", ry: "9", fill: "#F5D548" }), /* @__PURE__ */ React.createElement(
    "path",
    {
      fillRule: "evenodd",
  ...
  var SiteSearchOverlay = ({ go, onClose }) => {
  ...
  var Nav2 = ({ route, go, user, onLogout }) => {
    ...
    const learnChildren = [
      { key: "lectures", label: navL.lectures || "\uAC15\uC5F0", desc: "\uD568\uAED8 \uB4E3\uB294 \uC5ED\uC0AC\xB7\uBB38\uD654 \uAC15\uC5F0" },
    ...
    const items = [
      ...
      { key: "tour", label: navL.tour || "\uB2F5\uC0AC\xB7\uD22C\uC5B4" },
    ...
    return /* @__PURE__ */ React.createElement("nav", { className: `nav ${mobileOpen ? "mobile-open" : ""}`, "aria-label": "\uC8FC \uBA54\uB274" }, /* @__PURE__ */ React.createElement("div", { className: "container nav-inner" }, /* @__PURE__ */ React.createElement(Brand, { onClick: () => go("home") }), /* @__PURE__ */ React.createElement(
      ...
      const onClick = isLearn ? () => toggleMega("learn") : () => go(it.defaultRoute || it.key);
      return /* @__PURE__ */ React.createElement(
        "li",
        {
          key: it.key,
        ...
        it.isMega === "learn" && /* @__PURE__ */ React.createElement(
          "div",
          {
            className: "nav-mega nav-mega-play",
            role: "menu",
            "aria-label": "\uBC30\uC6C0 \u2014 \uAC15\uC5F0\xB7\uB3C4\uC11C",
            onMouseEnter: () => openMegaMenu("learn"),
          ...
          /* @__PURE__ */ React.createElement("div", { className: "mono dim-2", style: { fontSize: 9, letterSpacing: "0.22em", padding: "6px 16px 8px" } }, "LEARN"),
          /* @__PURE__ */ React.createElement("ul", { style: { listStyle: "none", margin: 0, padding: 0 } }, learnChildren.map((p) => /* @__PURE__ */ React.createElement("li", { key: p.key }, /* @__PURE__ */ React.createElement(
            "button",
            {
              type: "button",
              role: "menuitem",
        ...
        it.isMega === "learn" && /* @__PURE__ */ React.createElement("ul", { className: "nav-mobile-submenu", role: "list", "aria-label": "\uBC30\uC6C0 \uD558\uC704", style: { listStyle: "none", margin: 0, padding: 0 } }, learnChildren.map((p) => /* @__PURE__ */ React.createElement("li", { key: p.key }, /* @__PURE__ */ React.createElement(
          "button",
          {
            type: "button",
        ...
        it.isMega === "community" && /* @__PURE__ */ React.createElement("ul", { className: "nav-mobile-submenu", role: "list", "aria-label": "\uCEE4\uBBA4\uB2C8\uD2F0 \uD558\uC704", style: { listStyle: "none", margin: 0, padding: 0 } }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(
          "button",
          {
            type: "button",
            className: `nav-link nav-sub-link ${route === "column" ? "active" : ""}`,
            "aria-current": route === "column" ? "page" : void 0,
            onClick: () => go("column")
          },
          "\uBC45\uAE30\uB178\uC790 \uCE7C\uB7FC"
        )), communityBoards.map((b) => /* @__PURE__ */ React.createElement("li", { key: b.id }, /* @__PURE__ */ React.createElement(
          "button",
          {
            type: "button",
        ...
        it.isMega === "community" && communityBoards.length > 0 && /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { className: "mono dim-2", style: { fontSize: 9, letterSpacing: "0.22em", padding: "6px 16px 8px" } }, "COLUMN"),
          /* @__PURE__ */ React.createElement("ul", { style: { listStyle: "none", margin: 0, padding: 0 } }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(
            "button",
            {
              type: "button",
              role: "menuitem",
            ...
            /* @__PURE__ */ React.createElement("span", null, "\uBC45\uAE30\uB178\uC790 \uCE7C\uB7FC")
          ))),
          /* @__PURE__ */ React.createElement("div", { className: "mono dim-2", style: { fontSize: 9, letterSpacing: "0.22em", padding: "10px 16px 8px", borderTop: "1px solid var(--line)", marginTop: 6 } }, "BOARDS"),
  ...
  var Footer2 = ({ go }) => {
    ...
    } }, footer.description || "\uBC45\uAE30\uD0C0\uACE0 \uB178\uC790. \uBC45\uAE30\uB178\uC790\uB294 \uD55C\uAD6D\uC758 \uC5ED\uC0AC\xB7\uBB38\uD654\xB7\uC790\uC5F0\uC744 \uD568\uAED8 \uAC77\uACE0 \uB290\uB07C\uBA70 \uB098\uB204\uB294 \uC5EC\uD589 \uAD11\uC7A5\uC785\uB2C8\uB2E4. \uAD81\uAD90 \uB2F5\uC0AC\uBD80\uD130 \uC9C0\uC5ED \uC5EC\uD589\uAE4C\uC9C0, \uD568\uAED8 \uB9CC\uB4E4\uC5B4\uAC00\uB294 \uC5EC\uD589.")), /* @__PURE__ */ React.createElement("nav", { "aria-label": "\uCF58\uD150\uCE20 \uBC14\uB85C\uAC00\uAE30" }, /* @__PURE__ */ React.createElement("h4", { id: "ft-content", style: headingStyle }, footer.headingContent || "\uCF58\uD150\uCE20"), /* @__PURE__ */ React.createElement("ul", { "aria-labelledby": "ft-content" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("sleep") }, "\uC790\uACE0 \uB180\uC790")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("tour") }, "\uD22C\uC5B4 \uD504\uB85C\uADF8\uB7A8")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("lectures") }, "\uAC15\uC5F0")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("book") }, "\uBC45\uAE30\uB178\uC790 \uB3C4\uC11C")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("column") }, "\uBC45\uAE30\uB178\uC790 \uCE7C\uB7FC")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("community") }, "\uAD11\uC7A5")))), /* @__PURE__ */ React.createElement("nav", { "aria-label": "\uC815\uBCF4 \uBC14\uB85C\uAC00\uAE30" }, /* @__PURE__ */ React.createElement("h4", { id: "ft-info", style: headingStyle }, footer.headingInfo || "\uC815\uBCF4"), /* @__PURE__ */ React.createElement("ul", { "aria-labelledby": "ft-info" }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("lectures") }, "\uAC15\uC5F0 \uC77C\uC815")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("community") }, "\uACF5\uC9C0\uC0AC\uD56D")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("faq") }, "\uC790\uC8FC \uBB3B\uB294 \uC9C8\uBB38")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("terms") }, "\uC774\uC6A9\uC57D\uAD00")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => go("privacy") }, "\uAC1C\uC778\uC815\uBCF4 \uCC98\uB9AC\uBC29\uCE68")))), /* @__PURE__ */ React.createElement("address", { style: { fontStyle: "normal" } }, /* @__PURE__ */ React.createElement("h4", { id: "ft-contact", style: headingStyle }, footer.headingContact || "\uC5F0\uB77D"), /* @__PURE__ */ React.createElement("ul", { "aria-labelledby": "ft-contact" }, email && /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", { href: `mailto:${email}` }, email)), address && /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", null, address))))), (companyName || bizRegNo || ceo) && /* @__PURE__ */ React.createElement("div", { className: "footer-biz", style: {
      marginTop: 24,
      paddingTop: 16,
  ...
  var Ornament = ({ children }) => /* @__PURE__ */ React.createElement("div", { className: "ornament", style: { margin: "40px 0" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-serif)", fontSize: 14, letterSpacing: "0.3em", color: "var(--primary)" } }, children || "\u4E94"));
  var SectionHead = ({ eyebrow, title, subtitle, action, level = 2 }) => {
    const H = `h${level}`;
  ...
  var Tweaks2 = ({ tweaks, setTweaks, visible }) => {
    if (!visible) return null;
  ...
  var CoverPlaceholder = ({ aspectRatio = "16/10", label, iconSize = 88 }) => /* @__PURE__ */ React.createElement("div", { className: "placeholder", style: {
    aspectRatio,
    position: "relative",
    display: "grid",
    placeItems: "center",
  ...
  var _MemoNav = React.memo(Nav2);
  var _MemoFooter = React.memo(Footer2);
  var _MemoCookieConsent = React.memo(CookieConsent2);
  var PastBoardList = ({ items = [], type = "tour", onSelect }) => {
  ...
  var __confirmListeners = [];
  var __subscribeConfirm = (fn) => {
...
`;
  ...
  var RecommendationDetailModal = ({ rec, onClose, go }) => {
    var _a;
  ...
  var truncatePreview = (text, max = 110) => {
  ...
  var BookGridSection = ({ go, dataTick, text }) => {
    const _arr2 = (fn) => {
      try {
        const v = fn();
        return Array.isArray(v) ? v : [];
    ...
    const won = (n) => {
      var _a, _b, _c;
      try {
        return (_c = (_b = (_a = window.BGNJ_FMT) == null ? void 0 : _a.won) == null ? void 0 : _b.call(_a, n)) != null ? _c : `${Number(n || 0).toLocaleString("ko-KR")}\uC6D0`;
      } catch (e) {
        return `${n}\uC6D0`;
      }
    };
    return /* @__PURE__ */ React.createElement(HomeSectionBoundary, { label: "\uCC45" }, /* @__PURE__ */ React.createElement("section", { className: "home-books" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { className: "home-feed-head" }, /* @__PURE__ */ React.createElement("div", { className: "home-feed-label mono" }, text.bookEyebrow || "\uBC45\uAE30\uB178\uC790 \uCD9C\uD310"), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      books.length,
      "\uAD8C \u2192"
    )), /* @__PURE__ */ React.createElement("div", { className: "home-book-grid" }, books.map((b) => /* @__PURE__ */ React.createElement(
      "article",
      {
        key: b.id,
        className: "home-book",
  ...
  var HomePage = ({ go }) => {
    ...
    const publicColumns = React.useMemo(() => G2.arr(() => {
      var _a, _b;
      return (_b = (_a = window.BGNJ_COLUMNS) == null ? void 0 : _a.listPublic) == null ? void 0 : _b.call(_a);
    }), [columnsTick]);
    ...
    const primaryImage = React.useCallback((kind, id) => {
      ...
      try {
        ...
        const imgs = (_a = pages == null ? void 0 : pages[id]) == null ? void 0 : _a.images;
        if (!Array.isArray(imgs) || imgs.length === 0) return "";
        return ((_b = imgs.find((x) => x && x.isPrimary) || imgs[0]) == null ? void 0 : _b.url) || "";
      } catch (e) {
        return "";
      }
    }, [sc]);
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "home-page", style: { fontSize: `${fontScale}em` } }, recDetail && /* @__PURE__ */ React.createElement(RecommendationDetailModal, { rec: recDetail, onClose: () => setRecDetail(null), go }), /* @__PURE__ */ React.createElement(HomeSectionBoundary, { label: "\uD788\uC5B4\uB85C" }, /* @__PURE__ */ React.createElement("section", { className: `hero-d${hero.bgDesktopUrl || hero.bgMobileUrl ? " has-bg" : ""}` }, (hero.bgDesktopUrl || hero.bgMobileUrl) && /* @__PURE__ */ React.createElement("div", { className: "hero-d-bg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement(
    ...
    ))), (featuredColumn || featuredEvent) && /* @__PURE__ */ React.createElement(HomeSectionBoundary, { label: "\uBC18\uC804 \uBE14\uB85D" }, /* @__PURE__ */ React.createElement("section", { className: "home-split" }, featuredColumn && /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "home-split-half",
        ...clickable(() => go("column"), `\uCE7C\uB7FC: ${featuredColumn.title}`),
        onMouseEnter: () => setColumnPaused(true),
        onMouseLeave: () => setColumnPaused(false)
      },
      /* @__PURE__ */ React.createElement("div", { className: "home-split-eb mono" }, homeText.columnEyebrow || "\uC774\uBC88 \uC8FC\uC758 \uAE30\uB85D"),
      /* @__PURE__ */ React.createElement("h3", { className: "home-split-title" }, featuredColumn.title),
      featuredColumn.excerpt && /* @__PURE__ */ React.createElement("p", { className: "home-split-body" }, truncatePreview(featuredColumn.excerpt, 130)),
      /* @__PURE__ */ React.createElement("span", { className: "home-split-link mono" }, "\uC77D\uAE30 \u2192")
    ), featuredEvent && (() => {
      ...
      return /* @__PURE__ */ React.createElement(
        "div",
        {
          className: "home-split-half home-split-half--ink home-split-half--event",
          ...clickable(() => {
            try {
        ...
        poster && /* @__PURE__ */ React.createElement(
          "div",
          {
            className: "home-split-poster",
            role: "img",
            "aria-label": `${title} \uD3EC\uC2A4\uD130`,
            style: { backgroundImage: `url(${poster})` }
          }
        ),
        /* @__PURE__ */ React.createElement("div", { className: "home-split-eventtext" }, /* @__PURE__ */ React.createElement("div", { className: "home-split-eb mono" }, isPast ? `\uC9C0\uB09C ${label}\uC785\uB2C8\uB2E4` : `\uB2E4\uC74C ${label}`), /* @__PURE__ */ React.createElement("h3", { className: "home-split-title" }, title), when && /* @__PURE__ */ React.createElement("div", { className: "home-split-when mono" }, when), /* @__PURE__ */ React.createElement("p", { className: "home-split-body" }, item.desc ? truncatePreview(item.desc, 110) : item.venue || ""), /* @__PURE__ */ React.createElement("span", { className: "home-split-link mono" }, isPast ? `\uC9C0\uB09C ${label} \uBCF4\uAE30` : `${label} \uC790\uC138\uD788 \uBCF4\uAE30`, " \u2192"))
      );
    })())), recentEntries.length > 0 && /* @__PURE__ */ React.createElement(HomeSectionBoundary, { label: "\uCD5C\uADFC \uAE30\uB85D" }, /* @__PURE__ */ React.createElement("section", { className: "home-feed" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { className: "home-feed-head" }, /* @__PURE__ */ React.createElement("div", { className: "home-feed-label mono" }, "\uCD5C\uADFC \uAE30\uB85D"), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        className: "btn-ghost mono",
      ...
      "\uD3B8 \u2192"
    )), recentEntries.map((it) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: `${it.kind}-${it.id}`,
    ...
    }))))), /* @__PURE__ */ React.createElement(BookGridSection, { go, dataTick, text: homeText }));
  };
  ...
  var HomeNextPage = ({ go }) => {
    ...
    const activeTours = React.useMemo(() => G2.arr(() => {
      var _a2, _b2;
    ...
    ))))))), /* @__PURE__ */ React.createElement("section", { className: "hn-hero" }, (hero.bgDesktopUrl || hero.bgMobileUrl) && /* @__PURE__ */ React.createElement("div", { className: "hn-hero-bg", style: { backgroundImage: `url(${hero.bgDesktopUrl || hero.bgMobileUrl})` } }), /* @__PURE__ */ React.createElement("div", { className: "hn-hero-fade" }), /* @__PURE__ */ React.createElement("div", { className: "container hn-hero-inner" }, /* @__PURE__ */ React.createElement("h1", { className: "hn-h1" }, "\uC2DC\uAC04\uC744 \uAC77\uACE0,", /* @__PURE__ */ React.createElement("br", null), "\uC5ED\uC0AC\uB97C \uAE30\uB85D\uD558\uACE0,", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { className: "hn-h1-accent" }, "\uC0AC\uB78C\uC744 \uB9CC\uB098\uB294 \uC778\uBB38\uAE30\uD589")), /* @__PURE__ */ React.createElement("p", { className: "hn-lead" }, "\uBC45\uAE30\uB178\uC790\uB294 \uD604\uB300\uC758 \uC0AC\uAD00\uC785\uB2C8\uB2E4."), /* @__PURE__ */ React.createElement("p", { className: "hn-sub" }, "\uC870\uC120\uC758 \uC0AC\uAD00\uC774 \uC2DC\uB300\uB97C \uAE30\uB85D\uD588\uB4EF,", /* @__PURE__ */ React.createElement("br", null), "\uC624\uB298 \uC6B0\uB9AC\uB294 \uAE38 \uC704\uC5D0\uC11C \uC0AC\uB78C\uACFC \uACF5\uAC04, \uBB38\uD654\uB97C \uAE30\uB85D\uD569\uB2C8\uB2E4.", /* @__PURE__ */ React.createElement("br", null), "\uC624\uB298\uC758 \uACBD\uD5D8\uC744 \uB0B4\uC77C\uC758 \uC2E4\uB85D\uC73C\uB85C \uB0A8\uAE30\uB294 \uC778\uBB38\uD0D0\uBC29 \uD50C\uB7AB\uD3FC\uC785\uB2C8\uB2E4."), /* @__PURE__ */ React.createElement("div", { className: "hn-cta-row" }, heroCtas.map((c, i) => /* @__PURE__ */ React.createElement("button", { key: i, type: "button", className: "hn-cta-pill", onClick: c.action }, ctaIcons[i] && /* @__PURE__ */ React.createElement("span", { className: "hn-cta-pill-icon" }, /* @__PURE__ */ React.createElement("img", { src: ctaIcons[i], alt: "" })), /* @__PURE__ */ React.createElement("span", { className: "hn-cta-pill-text" }, c.label)))))), /* @__PURE__ */ React.createElement("section", { className: "hn-cards" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { className: "hn-cards-grid" }, /* @__PURE__ */ React.createElement(
      "article",
      {
  ...
  var _stripAttachedBlock = (html) => {
    ...
    try {
      ...
      const root2 = doc.getElementById("__root__");
      if (!root2) return html;
      root2.querySelectorAll('[data-bgnj-attached-block="1"]').forEach((node) => node.remove());
  ...
  var ImageAttacher = ({ images, setImages, max = 10 }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { className: "field-label" }, "\uCCA8\uBD80 \uC774\uBBF8\uC9C0 ", /* @__PURE__ */ React.createElement("span", { className: "dim-2" }, "(", images.length, "/", max, ")")), /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        ...
        style: { background: "rgba(0,0,0,0.6)", border: "none", color: "var(--on-scrim)", fontSize: 10, padding: "1px 5px", cursor: "pointer", minHeight: 0 }
      },
      "\u25C0"
    ), /* @__PURE__ */ React.createElement(
      "button",
  ...
  var FILE_MAX_SIZE = FILE_MAX_TOTAL;
  ...
  var MentionTextarea = ({ value, onChange, authors, rows = 4, placeholder, style }) => {
    const ref = React.useRef(null);
    const [open, setOpen] = React.useState(false);
  ...
  var POSTS_PER_PAGE_OPTIONS = [10, 30, 50, 100];
  ...
  var CommunityPage = ({ go, postId, setPostId, user }) => {
    ...
    const handleMovePost = React.useCallback(async (post, direction) => {
      ...
      const newer = targetIdx > 0 ? others[targetIdx - 1] : null;
      const older = targetIdx < others.length ? others[targetIdx] : null;
      const toMs = (p) => {
      ...
      if (newer && older && Number.isFinite(newerMs) && Number.isFinite(olderMs) && newerMs > olderMs) {
        ...
        targetMs = gap > 2e3 ? Math.floor((newerMs + olderMs) / 2) : olderMs + Math.max(1, Math.floor(gap / 2));
      } else if (!newer && older && Number.isFinite(olderMs)) {
        targetMs = olderMs + 1e3;
      } else if (newer && !older && Number.isFinite(newerMs)) {
        targetMs = newerMs - 1e3;
      } else {
        targetMs = Date.now();
      }
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "section" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("header", { style: { marginBottom: 24 } }, (() => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("td", { className: "col-num mono dim-2", style: { padding: "18px 8px", fontSize: 12 } }, canRenumber ? (() => {
          ...
          return /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", null, rowNum), /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", flexDirection: "column", gap: 1 } }, /* @__PURE__ */ React.createElement(
            "button",
            {
              type: "button",
              ...
              title: "\uC704\uB85C (\uCD5C\uC2E0 \uBC29\uD5A5)",
              "aria-label": "\uC704\uB85C \uD55C \uCE78",
              style: arrowBtnStyle(isTop || busy)
            },
            "\u25B2"
          ), /* @__PURE__ */ React.createElement(
            "button",
            {
              ...
              title: "\uC544\uB798\uB85C (\uACFC\uAC70 \uBC29\uD5A5)",
              "aria-label": "\uC544\uB798\uB85C \uD55C \uCE78",
              style: arrowBtnStyle(isBottom || busy)
            },
            "\u25BC"
          )));
        })() : rowNum),
  ...
  var draftKeyFor = (userId) => `bgnj_post_draft_${userId || "guest"}`;
  var PostCompose = ({ user, initialPost, onCancel, onPublish, categories, userLevel, onPayloadChange }) => {
    var _a, _b, _c, _d, _e;
    const writable = categories.filter((c) => {
      var _a2, _b2;
  ...
  var PostDetail = ({ post, siblings, go, setPostId, user, onRefresh, onEdit }) => {
    ...
    return /* @__PURE__ */ React.createElement("article", { className: "section post-read" }, /* @__PURE__ */ React.createElement("div", { className: "container post-read-container" }, /* @__PURE__ */ React.createElement("div", { className: "post-back-bar" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn post-back-btn", onClick: () => setPostId(null) }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: { fontSize: 16, lineHeight: 1 } }, "\u2190"), /* @__PURE__ */ React.createElement("span", null, "\uBAA9\uB85D\uC73C\uB85C"), post.category && /* @__PURE__ */ React.createElement("span", { className: "mono dim-2 post-back-board" }, post.category))), /* @__PURE__ */ React.createElement("header", { style: { borderBottom: "1px solid var(--line-2)", paddingBottom: 32, marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, marginBottom: 20, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { className: "badge badge-gold" }, post.category), post.hot && /* @__PURE__ */ React.createElement("span", { className: "badge" }, "HOT"), post._userCreated && /* @__PURE__ */ React.createElement("span", { className: "badge badge-gold" }, "\uC0C8 \uAE00")), /* @__PURE__ */ React.createElement("h1", { className: "post-title", style: {
      ...
      /* @__PURE__ */ React.createElement("span", { className: "mono dim-2", style: { fontSize: 10, letterSpacing: "0.18em", display: "block", marginBottom: 6 } }, "\u2190 \uC774\uC804 \uAE00"),
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: "var(--ink)", wordBreak: "keep-all", overflowWrap: "break-word" } }, prevPost ? prevPost.title : "\uC774\uC804 \uAE00\uC774 \uC5C6\uC2B5\uB2C8\uB2E4")
    ), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      return /* @__PURE__ */ React.createElement("li", { key: p.id, style: { borderBottom: "1px solid var(--line)" } }, /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "mono dim-2", style: { fontSize: 10 } }, isCurrent ? "\u25B6" : "\xB7"),
  ...
  var TourPage = ({ go, user }) => {
    ...
    const bank = React.useMemo(() => G2.call(() => {
      var _a2, _b2, _c2;
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "section" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { className: "section-eyebrow" }, introEyebrow), /* @__PURE__ */ React.createElement("h1", { className: "section-title" }, introPrefix, /* @__PURE__ */ React.createElement("span", { className: "accent" }, introAccent)), /* @__PURE__ */ React.createElement("p", { className: "section-subtitle" }, introSubtitle)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 24, flexWrap: "wrap", alignItems: "center" } }, [
      ...
      "\uFF0B \uD22C\uC5B4 \uCD94\uAC00"
    )), bucket === "upcoming" && tours.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "60px 20px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 14 } }, "\uC608\uC815\uB41C \uB2F5\uC0AC\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.")), bucket === "past" && !pastDetailId && (PastBoardList ? /* @__PURE__ */ React.createElement(
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 32 } }, CoverPlaceholder ? /* @__PURE__ */ React.createElement(window.CoverPlaceholder, { aspectRatio: "16/10", label: String(tour.title || "").toUpperCase() }) : /* @__PURE__ */ React.createElement("div", { className: "placeholder", style: { aspectRatio: "16/10", fontSize: 11 } }, String(tour.title || "").toUpperCase()));
  ...
  var TourQuickAddModal = ({ onClose, onSaved, initialTour = null }) => {
    var _a, _b, _c;
  ...
  var ColumnPage = ({ go, user }) => {
    ...
    const handleShare = async () => {
      var _a2, _b2;
      const num = (_b2 = (_a2 = window.BGNJ_COLUMNS) == null ? void 0 : _a2.numberOf) == null ? void 0 : _b2.call(_a2, selectedId);
    ...
    if (selectedId !== null) {
      ...
      })(), /* @__PURE__ */ React.createElement("span", { className: "pill" }, c.category), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-serif)", fontSize: 48, fontWeight: 500, lineHeight: 1.2, margin: "20px 0 16px" } }, c.title), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 20, justifyContent: "center", fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--ink-3)", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { className: "gold" }, c.author || "\uBC45\uAE30\uB178\uC790"), /* @__PURE__ */ React.createElement("span", null, c.createdAt ? window.BGNJ_FMT.kstShort(c.createdAt) : c.date || ""), /* @__PURE__ */ React.createElement("span", null, "\uC77D\uB294 \uC2DC\uAC04 \xB7 ", readTime), /* @__PURE__ */ React.createElement("span", null, "\uC870\uD68C ", views), /* @__PURE__ */ React.createElement("span", null, "\uACF5\uAC10 ", likes.length), /* @__PURE__ */ React.createElement("span", null, "\uB313\uAE00 ", comments.length))), c.coverUrl && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 40 } }, /* @__PURE__ */ React.createElement(
        "img",
        {
          src: c.coverUrl,
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "section" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 48 } }, (() => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { padding: 28 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", marginBottom: 12, flexWrap: "wrap" } }, (() => {
          var _a3, _b2;
          const num = (_b2 = (_a3 = window.BGNJ_COLUMNS) == null ? void 0 : _a3.numberOf) == null ? void 0 : _b2.call(_a3, c.id);
          return num ? /* @__PURE__ */ React.createElement("span", { className: "mono gold", style: { fontSize: 10, letterSpacing: "0.16em" } }, "#", String(num).padStart(3, "0")) : null;
        })(), /* @__PURE__ */ React.createElement("span", { className: "pill" }, c.category), /* @__PURE__ */ React.createElement("span", { className: "mono dim-2", style: { fontSize: 10 } }, readTime), likes.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "gold mono", style: { fontSize: 10 } }, "\u2665", likes.length), views > 0 && /* @__PURE__ */ React.createElement("span", { className: "dim-2 mono", style: { fontSize: 10 } }, "\uC870\uD68C ", views)), /* @__PURE__ */ React.createElement("h3", { className: "ko-serif", style: { fontSize: 19, fontWeight: 500, lineHeight: 1.35, marginBottom: 10, minHeight: 50 } }, c.title), /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 13, lineHeight: 1.6, marginBottom: 16 } }, String(c.excerpt || "").slice(0, 90), "\u2026"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: 16, borderTop: "1px solid var(--line)" } }, /* @__PURE__ */ React.createElement("span", { className: "mono dim-2", style: { fontSize: 10 } }, c.date), /* @__PURE__ */ React.createElement("span", { className: "gold mono", style: { fontSize: 10, letterSpacing: "0.2em" } }, "READ \u2192")))
      );
  ...
  var ColumnWriterModal = ({ onClose, initialColumn = null }) => {
    var _a, _b, _c;
  ...
  var BookReviewSection = ({ user, bookTitle }) => {
    var _a, _b, _c, _d;
  ...
  var BookPage = ({ go, cart, setCart, user }) => {
    const G2 = window.BGNJ_GUARD;
    const [tick, setTick] = React.useState(0);
    React.useEffect(() => {
  ...
  var HkGallery = ({ images, name }) => {
    ...
    const pickNext = React.useCallback((cur) => {
      ...
      if (cand.length < 4) cand = pool.slice();
      const a = cand.slice();
    ...
    React.useEffect(() => {
      ...
      const id = setInterval(() => setSide((cur) => pickNext(cur)), 3e3);
      return () => clearInterval(id);
  ...
  var HkPackageCard = ({ pkg, selected, startDate, onSelect, onInquire }) => {
    ...
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        style: { ...SOFT, padding: "20px 22px", display: "flex", flexDirection: "column", gap: 10, outline: selected ? "2px solid var(--secondary)" : "none" },
  ...
  var HkInquiryModal = ({ pkg, startDate, property, contactEmail, contactPhone, onClose }) => {
    var _a;
    const [name, setName] = React.useState("");
    const [phone, setPhone] = React.useState("");
    const [message, setMessage] = React.useState("");
    (_a = window.useModalGuard) == null ? void 0 : _a.call(window, { open: true, dirty: !!(name || phone || message), onClose, label: `${pkg.name} \uBB38\uC758` });
    const end = startDate ? hkAddDays(startDate, pkg.nights) : "";
...
\xB7 \uBA54\uC2DC\uC9C0: ${message}` : ""}`;
    ...
    const sendMail = () => {
      var _a2, _b, _c, _d;
      if (!name.trim() || !phone.trim()) {
        (_b = (_a2 = window.BGNJ_TOAST) == null ? void 0 : _a2.error) == null ? void 0 : _b.call(_a2, "\uC774\uB984\uACFC \uC5F0\uB77D\uCC98\uB97C \uC785\uB825\uD574 \uC8FC\uC138\uC694.");
        return;
      }
      try {
    ...
    const copySummary = async () => {
      ...
      try {
        ...
        (_b = (_a2 = window.BGNJ_TOAST) == null ? void 0 : _a2.success) == null ? void 0 : _b.call(_a2, "\uBB38\uC758 \uB0B4\uC6A9\uC744 \uBCF5\uC0AC\uD588\uC5B4\uC694. \uBA54\uC2DC\uC9C0\uB85C \uBCF4\uB0B4\uC8FC\uC138\uC694.");
      } catch (e) {
        (_d = (_c = window.BGNJ_TOAST) == null ? void 0 : _c.error) == null ? void 0 : _d.call(_c, "\uBCF5\uC0AC \uC2E4\uD328 \u2014 \uC9C1\uC811 \uC785\uB825\uD574 \uC8FC\uC138\uC694.");
      }
    };
    return /* @__PURE__ */ React.createElement(
      "div",
  ...
  var HangyeonPage = ({ go, user }) => {
    ...
    ), startDate && /* @__PURE__ */ React.createElement("span", { className: "dim-2", style: { fontSize: 12.5 } }, hkFmtDate(startDate), " \uC2DC\uC791")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 14 } }, packages.map((p) => /* @__PURE__ */ React.createElement(
      HkPackageCard,
      {
        key: p.id,
        pkg: p,
  ...
  var LecturesPage = ({ go, user }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "section" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 48 } }, /* @__PURE__ */ React.createElement("div", { className: "section-eyebrow" }, _lEyebrow), /* @__PURE__ */ React.createElement("h1", { className: "section-title" }, _lPrefix, /* @__PURE__ */ React.createElement("span", { className: "accent" }, _lAccent)), /* @__PURE__ */ React.createElement("p", { className: "section-subtitle" }, _lSubtitle)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 24, flexWrap: "wrap", alignItems: "center" } }, [
      ...
      "\uFF0B \uAC15\uC5F0 \uCD94\uAC00"
    )), bucket === "upcoming" && lectures.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "60px 20px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 14 } }, "\uC608\uC815\uB41C \uAC15\uC5F0\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.")), bucket === "past" && !pastDetailId && (PastBoardList ? /* @__PURE__ */ React.createElement(
      window.PastBoardList,
      {
        items: lectures,
        type: "lecture",
    ...
    ) : /* @__PURE__ */ React.createElement("div", { style: { padding: "60px 20px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 14 } }, "\uC9C0\uB09C \uAC15\uC5F0 \uBAA9\uB85D\uC744 \uBD88\uB7EC\uC624\uB294 \uC911\u2026"))), lectures.length > 0 && (bucket !== "past" || pastDetailId) && /* @__PURE__ */ React.createElement(React.Fragment, null, bucket === "past" && pastDetailId && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        className: "btn btn-small",
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 32 } }, CoverPlaceholder ? /* @__PURE__ */ React.createElement(window.CoverPlaceholder, { aspectRatio: "16/10", label: String(lecture.title || "").toUpperCase() }) : /* @__PURE__ */ React.createElement("div", { className: "placeholder", style: { aspectRatio: "16/10", fontSize: 11 } }, String(lecture.title || "").toUpperCase()));
    })(), (() => {
      var _a2, _b2, _c2;
      const sc = ((_b2 = (_a2 = window.BGNJ_SITE_CONTENT) == null ? void 0 : _a2.get) == null ? void 0 : _b2.call(_a2)) || {};
      const lp = ((_c2 = sc.lecturePages) == null ? void 0 : _c2[lecture.id]) || {};
  ...
  var LectureQuickAddModal = ({ onClose, onSaved, initialLecture = null }) => {
    var _a;
  ...
  var LectureBookingPanel = ({ lecture, user, bank, myReg, seats, labelStatus, tone, formatPrice, onRefresh, go }) => {
    const [selectedBankId, setSelectedBankId] = React.useState(null);
    const [open, setOpen] = React.useState(false);
    const [name, setName] = React.useState((user == null ? void 0 : user.name) || "");
    const [email, setEmail] = React.useState((user == null ? void 0 : user.email) || "");
  ...
  var LectureReviewsSection = ({ lecture, user, go, onRefresh }) => {
  ...
  var _ErrorIllustration = ({ src, alt }) => {
  ...
  var ErrorScreen = ({ embedded, children }) => embedded ? children : /* @__PURE__ */ React.createElement("div", { style: { minHeight: "calc(100vh - 80px)", display: "grid", placeItems: "center", padding: "40px 16px", background: "var(--bg)" } }, children);
  var Error404Page = ({ go, embedded }) => /* @__PURE__ */ React.createElement(ErrorScreen, { embedded }, /* @__PURE__ */ React.createElement(
    ErrorCard,
    {
      code: "404",
  ...
  var Error500Page = ({ go, onRetry, embedded }) => /* @__PURE__ */ React.createElement(ErrorScreen, { embedded }, /* @__PURE__ */ React.createElement(
    ErrorCard,
    {
      code: "500",
  ...
  var Error403Page = ({ go, embedded }) => /* @__PURE__ */ React.createElement(ErrorScreen, { embedded }, /* @__PURE__ */ React.createElement(
    ErrorCard,
    {
      code: "403",
  ...
  var Error401Page = ({ go, embedded }) => /* @__PURE__ */ React.createElement(ErrorScreen, { embedded }, /* @__PURE__ */ React.createElement(
    ErrorCard,
    {
      code: "401",
      title: "\uD0D1\uC2B9\uAD8C \uD655\uC778\uC774 \uD544\uC694\uD574\uC694.",
  ...
  var ErrorNetworkPage = ({ onRetry, embedded }) => /* @__PURE__ */ React.createElement(ErrorScreen, { embedded }, /* @__PURE__ */ React.createElement(
    ErrorCard,
    {
      code: null,
  ...
  var ErrorMaintenancePage = ({ go, embedded }) => /* @__PURE__ */ React.createElement(ErrorScreen, { embedded }, /* @__PURE__ */ React.createElement(
    ErrorCard,
    {
      code: null,
      title: "\uC11C\uBE44\uC2A4 \uC810\uAC80 \uC911\uC774\uC5D0\uC694.",
  ...
  var PageErrorBoundary = class extends React.Component {
    constructor(props) {
      super(props);
      this.state = { error: null };
    }
  ...
  var TOAST_DISMISS_MS = 1e4;
  var __reportingError = false;
  var reportErrorToServer = (entry) => {
    var _a, _b;
  ...
  var VALID_ROUTES = ["home", "home-next", "community", "lectures", "tour", "column", "book", "checkout", "mypage", "admin", "login", "signup", "faq", "terms", "privacy", "sleep", "hangyeon", "error"];
  var pathToRoute = (pathname) => {
  ...
  var _adminLoadPromise = null;
  var _loadAdminScripts = (attempt = 0) => {
    var _a;
  ...
  var _AdminLoadingFallback = ({ error, onRetry, label = "\uAD00\uB9AC\uC790" }) => {
  ...
  var App = () => {
    ...
    React.useEffect(() => {
      ...
      Promise.allSettled([
        ...
        (_J = (_I = (_H = (_G2 = (_F = (_E = (_D = window.BGNJ_API) == null ? void 0 : _D.categories) == null ? void 0 : _E.list) == null ? void 0 : _F.call(_E)) == null ? void 0 : _G2.then) == null ? void 0 : _H.call(_G2, (r) => {
