...
const HkaRoomTypes = () => {
  ...
  if (editing) {
    return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement("h4", { style: { margin: 0 } }, editing.id ? "\uC0C1\uD488 \uC218\uC815" : "\uC0C8 \uC0C1\uD488"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC0C1\uD488\uBA85", /* @__PURE__ */ React.createElement("input", { className: "field-input", value: editing.name, onChange: (e) => up({ name: e.target.value }), placeholder: "\uC2A4\uD0E0\uB2E4\uB4DC \uB354\uBE14\uB8F8 / \uC624\uB298\uC758 \uC791\uC5C5\uC2E4" })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC608\uC57D \uC720\uD615", /* @__PURE__ */ React.createElement("select", { className: "field-input", value: editing.bookingType, onChange: (e) => up({ bookingType: e.target.value }) }, /* @__PURE__ */ React.createElement("option", { value: "nightly" }, "\uC219\uBC15 (1\uBC15, \uCCB4\uD06C\uC778~\uCCB4\uD06C\uC544\uC6C3)"), /* @__PURE__ */ React.createElement("option", { value: "timeslot" }, "\uC2DC\uAC04\uC81C (\uC778\uC6D0+\uB0A0\uC9DC+\uC2DC\uAC04)"))), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uD310\uB9E4 \uC0C1\uD0DC", /* @__PURE__ */ React.createElement("select", { className: "field-input", value: editing.status, onChange: (e) => up({ status: e.target.value }) }, /* @__PURE__ */ React.createElement("option", { value: "active" }, "\uD310\uB9E4 \uAC00\uB2A5"), /* @__PURE__ */ React.createElement("option", { value: "inactive" }, "\uD310\uB9E4 \uBD88\uAC00")))), editing.bookingType === "timeslot" && /* @__PURE__ */ React.createElement("div", { className: "card", style: { padding: 12, background: "var(--bg-2)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, marginBottom: 8 } }, "\uC2DC\uAC04\uC81C \uC124\uC815"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC6B4\uC601 \uC2DC\uC791", /* @__PURE__ */ React.createElement("input", { type: "time", className: "field-input", value: editing.openTime || "", onChange: (e) => up({ openTime: e.target.value }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC6B4\uC601 \uC885\uB8CC", /* @__PURE__ */ React.createElement("input", { type: "time", className: "field-input", value: editing.closeTime || "", onChange: (e) => up({ closeTime: e.target.value }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC2AC\uB86F \uAE38\uC774(\uBD84)", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.slotMinutes, onChange: (e) => up({ slotMinutes: Number(e.target.value) }), placeholder: "60 / 180" }))), /* @__PURE__ */ React.createElement("p", { className: "dim-2", style: { fontSize: 11, margin: "8px 0 0" } }, "\uC608: 09:00~22:00, 60\uBD84 \u2192 \uD55C \uC2DC\uAC04 \uB2E8\uC704 \uC2AC\uB86F. 3\uC2DC\uAC04 \uB2E8\uC704\uBA74 180. \uC88C\uC11D \uC218 = \uC544\uB798 \u2018\uC218\uB7C9\u2019, \uC138\uC158 \uC694\uAE08 = \u2018\uAE30\uBCF8 \uC694\uAE08\u2019.")), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC124\uBA85", /* @__PURE__ */ React.createElement("textarea", { className: "field-input", rows: 2, value: editing.description, onChange: (e) => up({ description: e.target.value }) })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, editing.bookingType === "timeslot" ? "\uC88C\uC11D \uC218" : "\uAC1D\uC2E4 \uC218\uB7C9", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.quantity, onChange: (e) => up({ quantity: Number(e.target.value) }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, editing.bookingType === "timeslot" ? "\uCD5C\uB300 \uC778\uC6D0(1\uC608\uC57D)" : "\uCD5C\uB300 \uC778\uC6D0", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.maxOccupancy, onChange: (e) => up({ maxOccupancy: Number(e.target.value) }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uCE68\uB300 \uAD6C\uC131", /* @__PURE__ */ React.createElement("input", { className: "field-input", value: editing.bedConfig, onChange: (e) => up({ bedConfig: e.target.value }), placeholder: "\uB354\uBE14 1 (\uC219\uBC15)", disabled: editing.bookingType === "timeslot" }))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, editing.bookingType === "timeslot" ? "\uC138\uC158(1\uC778) \uC694\uAE08" : "\uAE30\uBCF8(\uD3C9\uC77C) \uC694\uAE08", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.basePrice, onChange: (e) => up({ basePrice: Number(e.target.value) }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC8FC\uB9D0(\uAE08\xB7\uD1A0) \uC694\uAE08", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.weekendPrice, onChange: (e) => up({ weekendPrice: e.target.value }), placeholder: "\uAE30\uBCF8\uACFC \uAC19\uC73C\uBA74 \uBE44\uC6C0" })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uCD5C\uC18C \uC219\uBC15(\uBC15)", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.minNights, onChange: (e) => up({ minNights: Number(e.target.value) }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uCD5C\uB300 \uC219\uBC15(\uBC15)", /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", value: editing.maxNights, onChange: (e) => up({ maxNights: Number(e.target.value) }) }))), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uD3B8\uC758\uC2DC\uC124 (\uC27C\uD45C \uAD6C\uBD84)", /* @__PURE__ */ React.createElement("input", { className: "field-input", value: (editing.amenities || []).join(", "), onChange: (e) => up({ amenities: e.target.value.split(",").map((s) => s.trim()).filter(Boolean) }), placeholder: "\uC5D0\uC5B4\uCEE8, \uC640\uC774\uD30C\uC774, \uCDE8\uC0AC, \uC8FC\uCC28" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, marginBottom: 6 } }, "\uC5F0\uBC15/\uC7A5\uAE30 \uD560\uC778"), (editing.discounts || []).map((d, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 8, marginBottom: 6 } }, /* @__PURE__ */ React.createElement("input", { type: "number", className: "field-input", style: { width: 90 }, value: d.minNights, placeholder: "N\uBC15\u2191", onChange: (e) => {
...
const HkaBookings = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 12, flexWrap: "wrap", alignItems: "center" } }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-small", style: { background: !status ? "var(--secondary)" : "var(--bg)", color: !status ? "#fff" : "var(--ink)" }, onClick: () => setStatus("") }, "\uC804\uCCB4"), Object.keys(HKA_STATUS).map((k) => /* @__PURE__ */ React.createElement("button", { key: k, type: "button", className: "btn btn-small", style: { background: status === k ? "var(--secondary)" : "var(--bg)", color: status === k ? "#fff" : "var(--ink)" }, onClick: () => setStatus(k) }, HKA_STATUS[k])), /* @__PURE__ */ React.createElement("span", { className: "dim-2", style: { fontSize: 12, marginLeft: "auto" } }, bookings.length, "\uAC74")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, bookings.map((b) => /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { className: "mono dim-2", style: { fontSize: 11, width: 84 } }, b.code),
    /* @__PURE__ */ React.createElement("span", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", null, b.name), " \xB7 ", b.roomTypeName, " \xB7 ", hkaDate(b.checkIn), "~", hkaDate(b.checkOut), " (", b.nights, "\uBC15)"),
    /* @__PURE__ */ React.createElement("span", { className: "badge" }, HKA_STATUS[b.status]),
    /* @__PURE__ */ React.createElement("span", { className: "badge", style: { borderColor: "var(--line)" } }, HKA_PAY[b.paymentStatus]),
    /* @__PURE__ */ React.createElement("span", { style: { width: 90, textAlign: "right", fontWeight: 600 } }, hkaWon(b.totalPrice))
  )), bookings.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "dim" }, "\uC608\uC57D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.")), detail && /* @__PURE__ */ React.createElement(HkaBookingDetail, { booking: detail, onClose: () => setDetail(null), onChanged: reload }));
};
const HkaGuests = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 13 } }, "\uD22C\uC219\uAC1D \uC815\uBCF4 \xB7 \uBC29\uBB38 \uD69F\uC218 \xB7 VIP \xB7 \uBE14\uB799\uB9AC\uC2A4\uD2B8. (\uC608\uC57D \uC2DC \uC790\uB3D9 \uC801\uB9BD, \uCCB4\uD06C\uC544\uC6C3 \uC2DC \uBC29\uBB38 +1)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, guests.map((g) => /* @__PURE__ */ React.createElement("div", { key: g.id, className: "card", style: { padding: "10px 14px", display: "flex", alignItems: "center", gap: 12, fontSize: 13 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", null, g.name || "(\uC774\uB984\uC5C6\uC74C)"), " ", g.vip ? /* @__PURE__ */ React.createElement("span", { className: "badge", style: { borderColor: "var(--primary)", color: "var(--primary-active)" } }, "VIP") : null, " ", g.blacklist ? /* @__PURE__ */ React.createElement("span", { className: "badge", style: { borderColor: "var(--danger)", color: "var(--danger)" } }, "\uBE14\uB799") : null, /* @__PURE__ */ React.createElement("div", { className: "dim-2", style: { fontSize: 12 } }, g.phone, " ", g.email ? `\xB7 ${g.email}` : "", " \xB7 \uBC29\uBB38 ", g.visits, "\uD68C")), /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-small", onClick: () => toggle(g, "vip") }, g.vip ? "VIP \uD574\uC81C" : "VIP"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-small", style: { color: g.blacklist ? "var(--ink)" : "var(--danger)" }, onClick: () => toggle(g, "blacklist") }, g.blacklist ? "\uBE14\uB799\uD574\uC81C" : "\uBE14\uB799\uB9AC\uC2A4\uD2B8"))), guests.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "dim" }, "\uACE0\uAC1D \uAE30\uB85D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.")));
};
const HkaPayments = () => {
  const [bookings, setBookings] = React.useState([]);
  React.useEffect(() => {
...
const HkaProperty = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 13, margin: 0 } }, "\uC190\uB2D8\uC774 \uBCF4\uB294 \uD55C\uCF20 \uC18C\uAC1C \uD398\uC774\uC9C0(\uC790\uACE0 \uB180\uC790) \uB0B4\uC6A9\uC785\uB2C8\uB2E4. \uC0AC\uC9C4\uC740 \uC5C6\uC5B4\uB3C4 \uC608\uC57D\uC740 \uC815\uC0C1 \uB3D9\uC791\uD569\uB2C8\uB2E4."), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC219\uC18C \uC774\uB984", /* @__PURE__ */ React.createElement("input", { className: "field-input", value: form.name, onChange: (e) => up({ name: e.target.value }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uD55C \uC904 \uC18C\uAC1C(\uD0DC\uADF8\uB77C\uC778)", /* @__PURE__ */ React.createElement("input", { className: "field-input", value: form.tagline, onChange: (e) => up({ tagline: e.target.value }), placeholder: "\uC804\uC8FC \uB3C4\uC2EC \uC18D, \uC870\uC6A9\uD55C \uD558\uB8FB\uBC24" }))), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC18C\uAC1C\uAE00", /* @__PURE__ */ React.createElement("textarea", { className: "field-input", rows: 3, value: form.desc, onChange: (e) => up({ desc: e.target.value }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC8FC\uC18C", /* @__PURE__ */ React.createElement("input", { className: "field-input", value: form.address, onChange: (e) => up({ address: e.target.value }), placeholder: "\uC804\uBD81 \uC804\uC8FC\uC2DC \uB355\uC9C4\uAD6C \uD314\uB2EC\uB85C 340-37" })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uCC3E\uC544\uAC00\uB294 \uAE38", /* @__PURE__ */ React.createElement("textarea", { className: "field-input", rows: 3, value: form.directions, onChange: (e) => up({ directions: e.target.value }) })), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12 } }, "\uC548\uB0B4/\uACF5\uC9C0(\uC120\uD0DD)", /* @__PURE__ */ React.createElement("textarea", { className: "field-input", rows: 2, value: form.notice, onChange: (e) => up({ notice: e.target.value }), placeholder: "\uC785\uC2E4 15:00 / \uD1F4\uC2E4 11:00 \uB4F1" })), window.MediaGalleryEditor && /* @__PURE__ */ React.createElement(window.MediaGalleryEditor, { value: form.images, onChange: (imgs) => up({ images: imgs }), folder: "hangyeon", label: "\uC219\uC18C \uB300\uD45C \uC0AC\uC9C4 (\uC120\uD0DD)", helpText: "\uC5C6\uC5B4\uB3C4 \uC608\uC57D\uC740 \uAC00\uB2A5\uD569\uB2C8\uB2E4.", max: 10 }), /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-gold", style: { alignSelf: "flex-start" }, onClick: save }, "\uC219\uC18C \uC815\uBCF4 \uC800\uC7A5"));
};
const HK_TABS = [
  ["\uC219\uC18C", HkaProperty],
  ["\uAC1D\uC2E4", HkaRoomTypes],
...
const HangyeonAdminPanel = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 13, marginBottom: 14, lineHeight: 1.7 } }, /* @__PURE__ */ React.createElement("strong", { className: "gold" }, "\uD55C\uCF20 \uC608\uC57D \uAD00\uB9AC (PMS)"), " \u2014 \uC804\uC8FC \uC219\uC18C. \uAC1D\uC2E4\xB7\uC694\uAE08\xB7\uC7AC\uACE0\xB7\uC608\uC57D\xB7\uACE0\uAC1D\xB7\uACB0\uC81C\xB7\uC6B4\uC601 \uD1B5\uD569 \uAD00\uB9AC. \uB370\uC774\uD130\uB294 D1 \uC11C\uBC84 \uC800\uC7A5."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 18, borderBottom: "1px solid var(--line)", paddingBottom: 12 } }, HK_TABS.map(([name]) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: name,
      type: "button",
