...
const HkaRoomTypes = () => {
  ...
  const blank = () => ({ name: "", description: "", images: [], quantity: 1, maxOccupancy: 2, bedConfig: "", amenities: [], basePrice: 0, weekendPrice: "", discounts: [], minNights: 1, maxNights: 30, status: "active", sortOrder: 0, bookingType: "nightly", openTime: "09:00", closeTime: "22:00", slotMinutes: 60, hourlyEnabled: true, hourlyPrice: 1e4, minHours: 3, dailyEnabled: true, dailyPrice: 6e4, weeklyEnabled: false, weeklyPrice: 0, monthlyEnabled: false, monthlyPrice: 0 });
  const save = async () => {
    var _a;
