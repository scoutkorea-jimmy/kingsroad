...
const HomeTextEditorPanel = () => {
  ...
  ), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 13, fontWeight: 700, color: "var(--primary)", minWidth: 60, textAlign: "right" } }, "\xD7", Number((_b = textDraft.fontScale) != null ? _b : 1).toFixed(2)), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      className: "btn btn-small",
