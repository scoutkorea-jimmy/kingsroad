...
const HkRoomCard = ({ room, onBook, memberDiscount }) => {
  ...
  const priceInfo = room.stayAvailable ? { v: room.stayTotal, label: `${room.nights}\uBC15`, suffix: "" } : room.dayHourlyAvailable ? { v: room.hourlyPrice, label: "\uC2DC\uAC04\uB2F9", suffix: "~" } : room.weeklyAvailable ? { v: room.weeklyTotal, label: "\uC8FC\uAC04(7\uBC15)", suffix: "" } : room.monthlyAvailable ? { v: room.monthlyTotal, label: "\uC6D4\uAC04(30\uBC15)", suffix: "" } : { v: 0, label: "", suffix: "" };
