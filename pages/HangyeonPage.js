...
const HangyeonPage = ({ go, user }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "section" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("header", { style: { marginBottom: 28 } }, /* @__PURE__ */ React.createElement("div", { className: "section-eyebrow", "aria-hidden": "true" }, "STAY \xB7 \uD55C\uCF20"), /* @__PURE__ */ React.createElement("h1", { className: "section-title", style: { display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", null, "\uD55C\uCF20"), /* @__PURE__ */ React.createElement("span", { className: "ko-serif", style: { fontSize: "0.5em", color: "var(--secondary)", fontStyle: "italic", fontWeight: 400 } }, tagline)), /* @__PURE__ */ React.createElement("p", { className: "section-subtitle", style: { maxWidth: 760 } }, desc)), images.length > 0 && window.MediaGalleryView && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 32 } }, /* @__PURE__ */ React.createElement(window.MediaGalleryView, { images, title: "\uD55C\uCF20", sectionLabel: "\uC219\uC18C \uC804\uACBD", withCover: true })), info.address && /* @__PURE__ */ React.createElement("div", { className: "card", style: { padding: "14px 18px", marginBottom: 28, fontSize: 13 } }, /* @__PURE__ */ React.createElement("span", { className: "mono dim-2", style: { fontSize: 10, marginRight: 8 } }, "\uC8FC\uC18C"), info.address, info.checkinInfo && /* @__PURE__ */ React.createElement("div", { className: "dim", style: { marginTop: 6 } }, info.checkinInfo))), /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("h2", { className: "section-title", style: { fontSize: 26, marginBottom: 18 } }, "\uAC1D\uC2E4"), roomTypes.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "card", style: { padding: 40, textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", { className: "dim", style: { margin: 0 } }, "\uD604\uC7AC \uB4F1\uB85D\uB41C \uAC1D\uC2E4\uC774 \uC5C6\uC2B5\uB2C8\uB2E4. \uACE7 \uB9CC\uB098\uC694.")) : /* @__PURE__ */ React.createElement("div", { className: "grid grid-3", style: { marginBottom: 16 } }, roomTypes.map((rt) => /* @__PURE__ */ React.createElement(HkRoomCard, { key: rt.id, rt, onBook: setBooking })))), /* @__PURE__ */ React.createElement(HkMyBookings, { tick }), booking && /* @__PURE__ */ React.createElement(
    HkBookingModal,
    {
      roomType: booking,
      user,
