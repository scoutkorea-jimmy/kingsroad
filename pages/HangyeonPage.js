...
const HkRoomCard = ({ room, onBook }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { ...SOFT, padding: 0, overflow: "hidden", display: "flex", flexWrap: "wrap", opacity: available ? 1 : 0.55 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "0 0 220px", minWidth: 180, background: "var(--bg-2)", overflow: "hidden" } }, cover ? /* @__PURE__ */ React.createElement("img", { src: cover.url, alt: room.name, style: { width: "100%", height: "100%", minHeight: 170, objectFit: "cover", display: "block" } }) : window.CoverPlaceholder ? /* @__PURE__ */ React.createElement(window.CoverPlaceholder, { aspectRatio: "4/3", iconSize: 44 }) : null), /* @__PURE__ */ React.createElement("div", { style: { flex: "1 1 280px", padding: "18px 20px", display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement("h3", { className: "ko-serif", style: { fontSize: 18, margin: 0 } }, room.name), /* @__PURE__ */ React.createElement("div", { className: "dim-2", style: { fontSize: 12.5 } }, "\uAE30\uC900 2\uBA85 / \uCD5C\uB300 ", room.maxOccupancy, "\uBA85", room.bedConfig ? ` \xB7 ${room.bedConfig}` : ""), room.dailyEnabled && /* @__PURE__ */ React.createElement("div", { style: { background: "var(--bg-2)", borderRadius: 10, padding: "8px 12px", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 12.5 } }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "dim-2" }, "\uCCB4\uD06C\uC778"), " 15:00"), /* @__PURE__ */ React.createElement("span", { className: "badge" }, room.nights, "\uBC15"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "dim-2" }, "\uCCB4\uD06C\uC544\uC6C3"), " 11:00")), room.hourlyEnabled && /* @__PURE__ */ React.createElement("div", { className: "dim-2", style: { fontSize: 11.5 } }, "\uC2DC\uAC04\uC81C ", hkWon(room.hourlyPrice), "/\uC2DC\uAC04 (\uCD5C\uC18C ", room.minHours, "\uC2DC\uAC04)"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: "auto", display: "flex", justifyContent: "flex-end", alignItems: "flex-end", gap: 12, paddingTop: 8 } }, available ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, room.stayAvailable && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "dim-2", style: { fontSize: 11 } }, room.nights, "\uBC15"), /* @__PURE__ */ React.createElement("div", { className: "ko-serif", style: { fontSize: 22, fontWeight: 700 } }, hkWon(room.stayTotal))), !room.stayAvailable && room.dayHourlyAvailable && /* @__PURE__ */ React.createElement("div", { className: "ko-serif", style: { fontSize: 20, fontWeight: 700 } }, hkWon(room.hourlyPrice), "~")) : /* @__PURE__ */ React.createElement("span", { className: "badge", style: { borderColor: "var(--danger)", color: "var(--danger)" } }, "\uC608\uC57D \uB9C8\uAC10"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-gold", disabled: !available, onClick: () => onBook(room), style: { opacity: available ? 1 : 0.5, minWidth: 110 } }, "\uC608\uC57D\uD558\uAE30"))));
};
