...
const BookPage = ({ go, cart, setCart, user }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "section" }, /* @__PURE__ */ React.createElement("div", { className: "container" }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 48 } }, (() => {
    ...
    fontSize: 12,
    color: "var(--gold)"
  } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 10, letterSpacing: "0.3em", marginBottom: 8 } }, "BANGINOJA PRESS"), /* @__PURE__ */ React.createElement("div", { className: "mono dim-2", style: { fontSize: 9, letterSpacing: "0.2em" } }, version === "KR" ? "KR EDITION" : "EN EDITION")), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-serif)", fontSize: 36, color: "var(--gold-2)", lineHeight: 1.2 } }, book.title), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 10, letterSpacing: "0.3em", marginTop: 20, color: "var(--ink-2)" } }, "\u2014 ", book.author || "\uBC45\uAE30\uB178\uC790", " \u2014")), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement(BanginojaIcon, { size: 28 }))), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 16, left: 16, right: -16, bottom: -16, border: "1px solid var(--line-2)", zIndex: -1 } })), (book.coverDataUri || book.backCoverDataUri || book.pdfPreviewDataUri) && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, justifyContent: "center", marginTop: 32 } }, book.coverDataUri && /* @__PURE__ */ React.createElement("div", { style: { width: 60, aspectRatio: "3/4", border: "1px solid var(--line)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("img", { src: book.coverDataUri, alt: "\uC55E\uD45C\uC9C0", style: { width: "100%", height: "100%", objectFit: "cover" } })), book.backCoverDataUri && /* @__PURE__ */ React.createElement("div", { style: { width: 60, aspectRatio: "3/4", border: "1px solid var(--line)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("img", { src: book.backCoverDataUri, alt: "\uB4B7\uD45C\uC9C0", style: { width: "100%", height: "100%", objectFit: "cover" } })), book.pdfPreviewDataUri && /* @__PURE__ */ React.createElement(
    "a",
    {
    ...
    /* @__PURE__ */ React.createElement("br", null),
    "\uBBF8\uB9AC\uBCF4\uAE30"
  ))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "mono gold", style: { fontSize: 11, letterSpacing: "0.3em", marginBottom: 16 } }, "NEW RELEASE \xB7 2026"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-serif)", fontSize: 56, fontWeight: 500, lineHeight: 1.05, marginBottom: 12 } }, "\u300E", /* @__PURE__ */ React.createElement("span", { className: "gold" }, book.title), "\u300F"), /* @__PURE__ */ React.createElement("div", { className: "ko-serif dim", style: { fontSize: 20, marginBottom: 24, fontStyle: "italic" } }, book.subtitle), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 24, paddingBottom: 24, borderBottom: "1px solid var(--line)", marginBottom: 32, fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--ink-2)" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "dim-2" }, "\uC800\uC790"), " ", /* @__PURE__ */ React.createElement("span", { className: "gold" }, book.author)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "dim-2" }, "\uCD9C\uD310"), " ", book.publisher), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "dim-2" }, "\uCABD\uC218"), " ", book.pages, "p")), /* @__PURE__ */ React.createElement("p", { className: "dim", style: { fontSize: 15, lineHeight: 1.9, marginBottom: 32 } }, book.desc), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { className: "mono dim-2", style: { fontSize: 10, letterSpacing: "0.25em", marginBottom: 12, textTransform: "uppercase" } }, "\uD310\uBCF8 \uC120\uD0DD"), (() => {
    const versions = [];
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: versions.length === 1 ? "1fr" : "1fr 1fr", gap: 12 } }, versions.map((v) => /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mono", style: { fontSize: 10, letterSpacing: "0.2em", color: version === v.k ? "var(--gold)" : "var(--ink-3)" } }, v.sub.toUpperCase()),
...
const CheckoutPage = ({ go, cart, user }) => {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (!(result == null ? void 0 : result.ok)) return setError((result == null ? void 0 : result.message) || "\uC8FC\uBB38 \uCC98\uB9AC\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
      setSubmittedOrder(result.order);
    } catch (err) {
      setError(((_a = err == null ? void 0 : err.body) == null ? void 0 : _a.error) || (err == null ? void 0 : err.message) || "\uC8FC\uBB38 \uCC98\uB9AC \uC911 \uC624\uB958");
    }
  };
