...
> **마지막 업데이트:** v00.067.000 · 2026-05-01 (칼럼 통합 + 모달 인프라 BGNJ_DRAFTS + useModalGuard + Tab 접근성)
...
| **v00.067** | 2026-05-01 | 칼럼 작성/목록 통합 모달 + BGNJ_DRAFTS(7일/10개) + useModalGuard(ESC/외부클릭 임시저장 prompt) + Tab focus-visible |
